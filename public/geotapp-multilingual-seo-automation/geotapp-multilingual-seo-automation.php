...
function gtmsa_on_transition_post_status($new_status, $old_status, $post) {
...
function gtmsa_map_deepl_language($lang) {
...
function gtmsa_filter_canonical_url($canonical_url, $post) {
...
function gtmsa_filter_robots_txt($output, $public) {
    $settings = gtmsa_get_settings();
    if (empty($settings['noindex_origin_host'])) {
        return $output;
    }
