...
const INFO_SECTIONS = {
  ...
  firebase: {
    ...
    bullets: [
      ...
      "Elenca le collection che vuoi sincronizzare (una per riga) cos├¼ i job su Render sanno cosa trattare.",
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <h2 className="text-xl font-semibold">Identit├á e stato</h2>
              </div>
              <button
                type="button"
            ...
            <div className="rounded-2xl border border-dashed border-white/20 p-4 text-sm text-slate-300">
              ...
              {content.branding.logoDataUrl ? (
                ...
                <p className="mt-3 text-xs">Nessun logo caricato: verr├á mostrato il fallback ÔÇ£GTÔÇØ.</p>
              )}
        ...
        <section className="space-y-4 rounded-3xl border border-white/10 bg-white/5 p-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <h3 className="text-xl font-semibold">Servizi ┬À Prezzi ┬À Chi siamo</h3>
            </div>
            <p className="text-xs text-slate-400">
          ...
          <details
            ...
            className="rounded-2xl border border-white/10 bg-white/5 p-4 scroll-mt-24"
          >
            <summary className="cursor-pointer text-lg font-semibold text-white">Servizi ┬À CTA</summary>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <details
            ...
            className="rounded-2xl border border-white/10 bg-white/5 p-4 scroll-mt-24"
          >
            <summary className="cursor-pointer text-lg font-semibold text-white">Prezzi ┬À Hero</summary>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              {(["eyebrow", "title", "description"] as const).map((field) => (
                <label
                  key={field}
          ...
          <details
            ...
            className="rounded-2xl border border-white/10 bg-white/5 p-4 scroll-mt-24"
          >
            <summary className="cursor-pointer text-lg font-semibold text-white">Prezzi ┬À Piani</summary>
            <div className="mt-4 grid gap-4 lg:grid-cols-3">
          ...
          <details
            ...
            className="rounded-2xl border border-white/10 bg-white/5 p-4 scroll-mt-24"
          >
            <summary className="cursor-pointer text-lg font-semibold text-white">Prezzi ┬À FAQ</summary>
          ...
          <details
            ...
            className="rounded-2xl border border-white/10 bg-white/5 p-4 scroll-mt-24"
          >
            <summary className="cursor-pointer text-lg font-semibold text-white">Chi siamo ┬À Hero</summary>
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              {(["eyebrow", "title", "description"] as const).map((field) => (
                <label
                  key={field}
          ...
          <details
            ...
            className="rounded-2xl border border-white/10 bg-white/5 p-4 scroll-mt-24"
          >
            <summary className="cursor-pointer text-lg font-semibold text-white">Chi siamo ┬À Valori</summary>
            <div className="mt-4 grid gap-4 md:grid-cols-3">
          ...
          <details
            ...
            className="rounded-2xl border border-white/10 bg-white/5 p-4 scroll-mt-24"
          >
            <summary className="cursor-pointer text-lg font-semibold text-white">Chi siamo ┬À Timeline</summary>
            <div className="mt-4 space-y-4">
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          type="button"
          onClick={() => notify("Mantieni almeno 3 loghi e 1 testimonianza per credibilit├á")}
          className="rounded-full border border-white/10 px-4 py-2 text-xs text-slate-300 hover:border-white/40"
        >
          Consigli
        </button>
