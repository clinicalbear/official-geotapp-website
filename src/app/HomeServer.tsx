...
const DIFF_COPY: Record<string, { h2_1: string; h2_2: string; desc: string; link: string }> = {
  ...
  da: { h2_1: 'Alt hvad de gør, gør vi også.', h2_2: 'Men hvad vi gør, kan de ikke.', desc: 'GPS-sporing, CRM, teamledelse: ja, det gør vi også. Men når en kunde bestrider dit arbejde, lader de andre dig alene. Vi giver dig en forseglet rapport, hvor enhver ændring kan spores, og det afslutter diskussionen.', link: 'Se forskellen' },
  sv: { h2_1: 'Allt de gör, gör vi också.', h2_2: 'Men det vi gör, kan de inte.', desc: 'GPS-spårning, CRM, teamhantering: ja, allt det gör vi också. Men när en kund ifrågasätter ditt arbete, lämnar de andra dig ensam. Vi ger dig en förseglad rapport där varje ändring syns, och det avslutar diskussionen.', link: 'Se skillnaden' },
  nb: { h2_1: 'Alt de gjør, gjør vi også.', h2_2: 'Men det vi gjør, kan de ikke.', desc: 'GPS-sporing, CRM, teamledelse: ja, alt det gjør vi også. Men når en kunde bestrider arbeidet ditt, lar de andre deg alene. Vi gir deg en forseglet rapport der enhver endring kan spores, og det avslutter diskusjonen.', link: 'Se forskjellen' },
  ...
  return (
    <div className="lp-l lp-home">
      ...
      <section className="op">
        ...
        <img
          className="bg"
          src="/hero-squadre.webp"
          srcSet="/hero-squadre-640.webp 640w, /hero-squadre-960.webp 960w, /hero-squadre-1280.webp 1280w, /hero-squadre.webp 1600w"
          sizes="100vw"
          width={1600}
          height={893}
          alt={L.alt_hero}
        ...
        <div className="w">
          ...
          {/* Il fatto tecnico che regge tutto il resto, a tutta larghezza sotto le
              ...
              (ICO, Garante, CNIL...), presa dalle schede paese verificate.
              Vedi landing.proof_note / proof_claim nei dizionari e
              src/lib/risorse/gps-lavoratori-ue/paesi/*.ts */}
          <p className="pnote">
            <i aria-hidden="true">✓</i>
            <span>{dict.landing.proof_note}</span>{' '}
            <b>{dict.landing.proof_claim}</b>
          </p>
        </div>
