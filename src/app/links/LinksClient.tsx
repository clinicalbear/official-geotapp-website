...
const UI: Record<string, {
  ...
  quickLabel: string;
  pricing: string; contact: string; mainSite: string;
  followUs: string;
  ...
  it: {
    ...
    ctaPrimary: 'Prenota una demo', ctaSecondary: 'Scopri come funziona',
  ...
  en: {
    ...
    sub: 'Certify every job in real time. No paper, no doubts, zero disputes.',
    ctaPrimary: 'Book a demo', ctaSecondary: 'See how it works',
  ...
  de: {
    ...
    sub: 'Jeden Einsatz in Echtzeit zertifizieren. Kein Papier, keine Zweifel, null Streitigkeiten.',
    ctaPrimary: 'Demo buchen', ctaSecondary: 'So funktioniert es',
  ...
  fr: {
    ...
    sub: 'Certifiez chaque intervention en temps réel. Zéro papier, zéro doute, zéro contestation.',
    ctaPrimary: 'Réserver une démo', ctaSecondary: 'Découvrir comment ça marche',
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-primary/20 selection:text-slate-900">
      ...
      <motion.nav initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
        ...
        <Link href={utm('https://geotapp.com', 'header_logo')}
      ...
      <motion.section initial="hidden" animate="show" variants={stagger}
        ...
        <motion.div variants={fadeUp} custom={3}>
          <Link href={utm(`https://geotapp.com/${langPath}/contact/`, 'cta_demo')}
        ...
        <motion.div variants={fadeUp} custom={4}>
          <Link href={utm(`https://geotapp.com/${langPath}/features/`, 'cta_features')}
        ...
        <motion.div variants={fadeUp} custom={5} className="flex items-center justify-center gap-2 mt-6 flex-wrap">
      ...
      <section className="px-6 py-9 max-w-md mx-auto">
        <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <Link href={utm('https://geotapp.com/blog', 'blog_all')} target="_blank" rel="noopener noreferrer"
      ...
      <section className="px-6 py-8 max-w-md mx-auto">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: '-20px' }}
          ...
          <QuickLink label={t.pricing} href={utm(`https://geotapp.com/${langPath}/pricing/`, 'quick_pricing')} />
          <QuickLink label={t.contact} href={utm(`https://geotapp.com/${langPath}/contact/`, 'quick_contact')} />
          <QuickLink label={t.mainSite} href={utm('https://geotapp.com', 'quick_main')} />
        </motion.div>
      </section>
      ...
      <section className="px-6 pb-8 max-w-md mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <a href={utm('https://www.instagram.com/geotapp_official/', 'social_instagram')} target="_blank" rel="noopener noreferrer" aria-label="Instagram"
            ...
            <a href={utm('https://www.linkedin.com/company/110850300/', 'social_linkedin')} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-100 text-slate-500 text-sm font-semibold hover:bg-slate-100 transition-all duration-150 active:scale-[0.97]">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
