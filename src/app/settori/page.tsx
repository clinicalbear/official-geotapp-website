...
> = {
  it: { title: 'Il tuo settore. La tua prova.', subtitle: 'Ogni intervento merita documentazione che regge in caso di contestazione.', installatori: 'Installatori', installatori_desc: 'Dimostra ogni intervento completato.', sicurezza: 'Sicurezza', sicurezza_desc: 'Prova presenze e ronde al cliente.', pulizie: 'Pulizie', pulizie_desc: 'Certifica ogni passaggio effettuato.', cta: 'Scopri come funziona' },
