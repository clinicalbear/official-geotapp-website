...
> = {
  it: { title: 'Il tuo settore. La tua prova.', subtitle: 'Ogni intervento merita documentazione che regge in caso di contestazione.', installatori: 'Installatori', installatori_desc: 'Dimostra ogni intervento completato.', sicurezza: 'Sicurezza', sicurezza_desc: 'Prova presenze e ronde al cliente.', pulizie: 'Pulizie', pulizie_desc: 'Documenta ogni passaggio effettuato.', elettricisti: 'Elettricisti', elettricisti_desc: 'Documenta ogni impianto elettrico con GPS e foto.', idraulici: 'Idraulici', idraulici_desc: 'Prova ogni intervento idraulico con rapportini GPS.', termoidraulici_desc: 'Prova ogni intervento su caldaie e impianti termici.', edilizia_desc: 'Documenta ore e presenze in cantiere.', manutenzione_desc: 'Prova ogni chiamata e ogni sopralluogo.', impianti_desc: 'Sigilla collaudi e messa in servizio.', cta: 'Scopri come funziona' },
  en: { title: 'Sectors & Solutions', subtitle: 'Select your sector to discover how GeoTapp can help you.', installatori: 'Installers', installatori_desc: 'Electricians, plumbers, maintenance.', sicurezza: 'Security', sicurezza_desc: 'Guards, stewards, events.', pulizie: 'Cleaning', pulizie_desc: 'Cleaning companies, facility management.', elettricisti: 'Electricians', elettricisti_desc: 'Document every electrical installation with GPS and photos.', idraulici: 'Plumbers', idraulici_desc: 'Prove every plumbing job with GPS reports.', termoidraulici_desc: 'Prove every boiler and heating system job.', edilizia_desc: 'Document hours and attendance on site.', manutenzione_desc: 'Prove every call-out and every site visit.', impianti_desc: 'Document testing and commissioning.', cta: 'Find out more' },
