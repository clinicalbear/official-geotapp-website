...
const HOMEPAGE_FAQ: Record<string, object> = {
  it: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Quanto costa GeoTapp?', acceptedAnswer: { '@type': 'Answer', text: 'GeoTapp ha un modello a licenze utente con prezzi trasparenti consultabili su geotapp.com/it/pricing/. GeoTapp TimeTracker parte da €4/operatore/mese con piani per piccole squadre (3-10 utenti), medie imprese (10-50) e grandi organizzazioni (50-300+). GeoTapp Verifier è incluso gratuitamente in ogni piano.' } },
  ...
  fr: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Combien coûte GeoTapp ?', acceptedAnswer: { '@type': 'Answer', text: 'GeoTapp utilise un modèle de licence par utilisateur avec des tarifs transparents sur geotapp.com/fr/tarifs/. GeoTapp TimeTracker à partir de 4 €/opérateur/mois, plans pour petites équipes (3-10 utilisateurs), PME (10-50) et grandes organisations (50-300+). GeoTapp Verifier toujours inclus.' } },
  ...
  pt: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Quanto custa a GeoTapp?', acceptedAnswer: { '@type': 'Answer', text: 'A GeoTapp usa um modelo de licenciamento por utilizador com preços transparentes em geotapp.com/pt/precos/. GeoTapp TimeTracker a partir de 4 €/operador/mês, com planos para equipas pequenas (3-10 utilizadores), PMEs (10-50) e grandes organizações (50-300+). GeoTapp Verifier sempre incluído.' } },
