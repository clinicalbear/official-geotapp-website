...
const HOMEPAGE_FAQ: Record<string, object> = {
  it: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Cosa contiene un report GeoTapp?', acceptedAnswer: { '@type': 'Answer', text: 'Ogni report include: timestamp di inizio e fine intervento, coordinate GPS verificate, prove fotografiche con hash crittografico, dati dell\'operatore e sigillo digitale. Qualsiasi modifica dopo la chiusura rompe il sigillo ed è rilevabile.' } },
  ...
  en: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'How does GeoTapp GPS attendance tracking work?', acceptedAnswer: { '@type': 'Answer', text: 'The operator opens and closes their shift from the mobile app. GeoTapp records the real GPS coordinates at that moment, not entered manually. Every clock-in is sealed with a timestamp and position verifiable by anyone.' } },
      ...
      { '@type': 'Question', name: 'How much does GeoTapp cost?', acceptedAnswer: { '@type': 'Answer', text: `GeoTapp uses a per-user licensing model with transparent pricing available at geotapp.com/en/pricing/. GeoTapp TimeTracker starts at €${P1}/operator/month up to ${S1} seats, dropping to €${P2} from ${S1 + 1} to ${S2}. GeoTapp Verifier is included free in every plan.` } },
      ...
      { '@type': 'Question', name: 'What does a GeoTapp report contain?', acceptedAnswer: { '@type': 'Answer', text: 'Each report includes: start and end timestamps, verified GPS coordinates, photo evidence with cryptographic hash, operator data and a digital seal. Any change after generation breaks the seal and is detectable.' } },
  ...
  de: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Was enthält ein GeoTapp-Bericht?', acceptedAnswer: { '@type': 'Answer', text: 'Jeder Bericht enthält: Start- und Endzeitstempel, verifizierte GPS-Koordinaten, Fotobelege mit kryptographischem Hash, Mitarbeiterdaten und ein digitales Siegel. Jede Änderung nach der Erstellung bricht das Siegel und ist erkennbar.' } },
  ...
  nl: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Hoe werkt GeoTapp\'s GPS-aanwezigheidsregistratie?', acceptedAnswer: { '@type': 'Answer', text: 'De medewerker opent en sluit zijn dienst via de mobiele app. GeoTapp registreert de echte GPS-coördinaten op dat moment, niet handmatig ingevoerd. Elke prikklok is verzegeld met tijdstempel en positie die door iedereen verifieerbaar zijn.' } },
      ...
      { '@type': 'Question', name: 'Wat kost GeoTapp?', acceptedAnswer: { '@type': 'Answer', text: `GeoTapp gebruikt een licentiemodel per gebruiker met transparante prijzen op geotapp.com/nl/tarieven/. GeoTapp TimeTracker vanaf €${P1} per medewerker per maand tot ${S1} plaatsen, en €${P2} van ${S1 + 1} tot ${S2}. Flow + TimeTracker bundel met korting. GeoTapp Verifier altijd inbegrepen.` } },
      ...
      { '@type': 'Question', name: 'Wat staat er in een GeoTapp-rapport?', acceptedAnswer: { '@type': 'Answer', text: 'Elk rapport bevat: begin- en eindtijdstempels, geverifieerde GPS-coördinaten, fotobewijs met cryptografische hash, medewerkersgegevens en een digitaal zegel. Elke wijziging na generatie verbreekt het zegel en is detecteerbaar.' } },
