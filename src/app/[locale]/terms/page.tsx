...
const TERMS_META: Record<string, { title: string; description: string; pageTitle: string; subtitle: string }> = {
  ...
  nl: { title: 'Algemene Voorwaarden | GeoTapp', description: 'Algemene servicevoorwaarden van GeoTapp: gebruik van het platform, abonnementen, aansprakelijkheid en gebruikersrechten.', pageTitle: 'Gebruiksvoorwaarden', subtitle: 'Versie 1.5 - september 2026' },
