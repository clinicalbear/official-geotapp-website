...
const META: Record<string, { title: string; description: string; pageTitle: string; subtitle: string }> = {
  ...
  es: { title: 'Política de privacidad | GeoTapp', description: 'Política de privacidad de GeoTapp: cómo recopilamos, utilizamos y protegemos sus datos personales de acuerdo con el RGPD.', pageTitle: 'Política de privacidad', subtitle: 'Versión 1.2 - 3 de septiembre de 2026' },
  pt: { title: 'Política de privacidade | GeoTapp', description: 'Política de privacidade do GeoTapp: como recolhemos, utilizamos e protegemos os seus dados pessoais em conformidade com o RGPD.', pageTitle: 'Política de privacidade', subtitle: 'Versão 1.2 - 3 de setembro de 2026' },
  nl: { title: 'Privacybeleid | GeoTapp', description: 'Privacybeleid van GeoTapp: hoe wij uw persoonsgegevens verzamelen, gebruiken en beschermen in overeenstemming met de AVG.', pageTitle: 'Privacybeleid', subtitle: 'Versie 1.2 - 3 september 2026' },
  da: { title: 'Privatlivspolitik | GeoTapp', description: 'GeoTapps privatlivspolitik: hvordan vi indsamler, bruger og beskytter dine personoplysninger i overensstemmelse med GDPR.', pageTitle: 'Privatlivspolitik', subtitle: 'Version 1.2 - 3. september 2026' },
  ...
  sv: { title: 'Integritetspolicy | GeoTapp', description: 'GeoTapps integritetspolicy: hur vi samlar in, använder och skyddar dina personuppgifter i enlighet med GDPR.', pageTitle: 'Integritetspolicy', subtitle: 'Version 1.2 - 3 september 2026' },
