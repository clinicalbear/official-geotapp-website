...
const FAQ: Record<string, FaqItem[]> = {
  ...
  nl: [
    { q: 'Wat is het belangrijkste verschil tussen GeoTapp en Factorial?', a: 'Factorial is een HR-platform voor kleine en middelgrote bedrijven, waar verlof, verzuim, organigram en inklokken op één plek staan. GeoTapp verzegelt het werk op locatie en maakt van elke opdracht een verzegeld document dat de opdrachtgever zelf verifieert. Het ene beheert mensen binnen het bedrijf, het andere verdedigt het werk daarbuiten.' },
...
const T: Record<string, Copy> = {
  it: {
    ...
    desc: 'Factorial mette ferie, assenze, organigramma e timbratura dentro un\'unica piattaforma HR, con prezzi pubblici e attivazione rapida. GeoTapp sigilla il singolo intervento, con GPS verificato, foto sigillate e un report che il cliente finale controlla da solo.',
    summary: 'In sintesi:',
  ...
  es: {
    ...
    desc: 'Factorial reúne vacaciones, ausencias, organigrama y fichaje en una sola plataforma de RRHH, con precios públicos y alta rápida. GeoTapp sella la intervención concreta, con GPS verificado, fotos selladas y un informe que el cliente final comprueba solo.',
    summary: 'En resumen:',
  ...
  nl: {
    ...
    desc: 'Factorial brengt verlof, verzuim, organigram en inklokken samen in één HR-platform, met openbare prijzen en een snelle start. GeoTapp verzegelt de losse opdracht, met geverifieerde GPS, verzegelde foto\'s en een rapport dat de eindklant zelf nakijkt.',
    summary: 'Kort gezegd:',
