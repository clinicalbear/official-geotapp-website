...
const COMPARISONS: Record<string, { tagline: string; highlight: string }>[] = [
  {
    ...
    pt: { tagline: 'Comunicação de equipa vs prova das intervenções', highlight: 'A Connecteam gere a comunicação. A GeoTapp produz provas verificáveis do trabalho.' },
    nl: { tagline: 'Teamcommunicatie vs werkbewijs', highlight: 'Connecteam beheert de communicatie. GeoTapp levert verifieerbaar bewijs van het werk.' },
    da: { tagline: 'Teamkommunikation vs dokumentation af arbejdet', highlight: 'Connecteam håndterer kommunikation. GeoTapp producerer verificerbart bevis for arbejdet.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Monitorização remota vs prova no terreno', highlight: 'A Hubstaff monitoriza trabalhadores remotos. A GeoTapp sela operadores físicos no terreno, conforme o RGPD.' },
    nl: { tagline: 'Monitoring op afstand vs bewijs in het veld', highlight: 'Hubstaff monitort externe werkers. GeoTapp verzegelt fysieke medewerkers op locatie - AVG-conform.' },
    da: { tagline: 'Fjernovervågning vs dokumentation i felten', highlight: 'Hubstaff overvåger fjernarbejdere. GeoTapp forsegler fysiske medarbejdere i marken - GDPR-kompatibel.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Registo de presenças vs prova das intervenções', highlight: 'A NoBadge regista presenças. A GeoTapp sela o trabalho com GPS anti-spoofing e relatórios verificáveis.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Registar vs provar', highlight: 'O PicaPonto regista as presencas a baixo custo com muitos metodos. A GeoTapp produz um relatorio selado que o cliente verifica sozinho.' },
    nl: { tagline: 'Registreren vs bewijzen', highlight: 'PicaPonto registreert aanwezigheid goedkoop met veel methodes. GeoTapp produceert een verzegeld rapport dat de klant zelf verifieert.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Software de limpeza DE vs prova no terreno', highlight: 'A Blink é a nº1 em limpeza na Alemanha. A GeoTapp acrescenta anti-spoofing e relatórios verificáveis.' },
    nl: { tagline: 'Schoonmaaksoftware DE vs bewijs in het veld', highlight: 'Blink is nummer 1 voor schoonmaak in Duitsland. GeoTapp voegt anti-spoofing toe en verifieerbare rapporten.' },
    da: { tagline: 'Rengøringssoftware DE vs dokumentation i felten', highlight: 'Blink er nr. 1 til rengøring i Tyskland. GeoTapp tilføjer anti-spoofing og rapporter med bevisværdi.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Plataforma de RH vs prova no terreno', highlight: 'A Factorial mantém em ordem férias, faltas e recibos. A GeoTapp defende a fatura quando o cliente contesta o serviço.' },
    nl: { tagline: 'HR-platform vs bewijs in het veld', highlight: 'Factorial houdt verlof, verzuim en loonstroken op orde. GeoTapp verdedigt de factuur als een klant de dienst betwist.' },
    da: { tagline: 'HR-platform vs dokumentation i felten', highlight: 'Factorial holder styr på ferie, fravær og lønsedler. GeoTapp forsvarer fakturaen, når kunden bestrider ydelsen.' },
