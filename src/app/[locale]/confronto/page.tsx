...
const META: Record<string, { title: string; description: string }> = {
  ...
  nl: {
    ...
    description: 'Vergelijk GeoTapp met Connecteam, Clockify, Hubstaff en anderen. Ontdek waarom GeoTapp de juiste keuze is voor bedrijven met medewerkers op locatie die werk moeten verzegelen.',
  },
  pt: {
    title: 'GeoTapp vs Concorrentes - Comparações completas | GeoTapp',
    description: 'Compare a GeoTapp com Connecteam, Clockify, Hubstaff e outros. Descubra porque a GeoTapp é a escolha certa para empresas com equipas no terreno que precisam de selar o trabalho.',
  },
  da: {
    title: 'GeoTapp vs konkurrenter - Komplette sammenligninger | GeoTapp',
    description: 'Sammenlign GeoTapp med Connecteam, Clockify, Hubstaff og andre. Find ud af, hvorfor GeoTapp er det rigtige valg for virksomheder med medarbejdere i marken, der skal forsegle udført arbejde.',
  },
  sv: {
    title: 'GeoTapp vs konkurrenter - Kompletta jämförelser | GeoTapp',
    description: 'Jämför GeoTapp med Connecteam, Clockify, Hubstaff och andra. Ta reda på varför GeoTapp är rätt val för företag med personal i fält som måste försegla utfört arbete.',
  },
  nb: {
    title: 'GeoTapp vs konkurrenter - Komplette sammenligninger | GeoTapp',
...
const COMPARISONS: Record<string, { tagline: string; highlight: string }>[] = [
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Registo de horas vs prova do trabalho realizado', highlight: 'A Clockify regista horas. A GeoTapp sela cada intervenção com GPS selado e fotos.' },
    nl: { tagline: 'Tijdregistratie vs bewijs van uitgevoerd werk', highlight: 'Clockify registreert uren. GeoTapp verzegelt elke opdracht met verzegeld GPS en foto\'s.' },
    da: { tagline: 'Tidsregistrering vs bevis for udført arbejde', highlight: 'Clockify registrerer timer. GeoTapp forsegler hver opgave med forseglet GPS og fotos.' },
    sv: { tagline: 'Tidsrapportering vs bevis på utfört arbete', highlight: 'Clockify registrerar timmar. GeoTapp förseglar varje uppdrag med förseglad GPS och foton.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Controlo de presenças vs prova do trabalho', highlight: 'A Jibble regista presenças com rosto e GPS básico. A GeoTapp prova cada intervenção com GPS selado e fotos.' },
    nl: { tagline: 'Aanwezigheidsregistratie vs bewijs van werk', highlight: 'Jibble registreert aanwezigheid met gezicht en basis-GPS. GeoTapp bewijst elke opdracht met verzegeld GPS en foto\'s.' },
    da: { tagline: 'Fremmøderegistrering vs arbejdsbevis', highlight: 'Jibble registrerer fremmøde med ansigt og basis-GPS. GeoTapp beviser hver opgave med forseglet GPS og fotos.' },
    sv: { tagline: 'Närvaroregistrering vs arbetsbevis', highlight: 'Jibble registrerar närvaro med ansikte och enkel GPS. GeoTapp bevisar varje uppdrag med förseglad GPS och foton.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Gestão de RH vs prova do trabalho no terreno', highlight: 'A Personio gere RH, férias e salários. A GeoTapp prova o trabalho no terreno com GPS selado e fotos. Complementares.' },
    nl: { tagline: 'HR-beheer vs bewijs van veldwerk', highlight: 'Personio beheert HR, verlof en loon. GeoTapp bewijst veldwerk met verzegeld GPS en foto\'s. Complementair.' },
    da: { tagline: 'HR-styring vs bevis for markarbejde', highlight: 'Personio styrer HR, fravær og løn. GeoTapp beviser markarbejde med forseglet GPS og fotos. Komplementære.' },
    sv: { tagline: 'HR-hantering vs bevis på fältarbete', highlight: 'Personio sköter HR, frånvaro och lön. GeoTapp bevisar fältarbete med förseglad GPS och foton. Komplementära.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Gestão e salários vs prova do trabalho', highlight: 'A Sage gere contabilidade e salários. A GeoTapp prova o trabalho no terreno com GPS selado e fotos. Complementares.' },
    nl: { tagline: 'Bedrijfssuite en loon vs bewijs van werk', highlight: 'Sage beheert boekhouding en loon. GeoTapp bewijst veldwerk met verzegeld GPS en foto\'s. Complementair.' },
    da: { tagline: 'Forretningssuite og løn vs arbejdsbevis', highlight: 'Sage styrer bogføring og løn. GeoTapp beviser markarbejde med forseglet GPS og fotos. Komplementære.' },
    sv: { tagline: 'Affärssuite och lön vs arbetsbevis', highlight: 'Sage sköter bokföring och lön. GeoTapp bevisar fältarbete med förseglad GPS och foton. Komplementära.' },
  ...
  } as any,
  {
    ...
    it: { tagline: 'Monitoraggio remoto vs certificazione sul campo', highlight: 'Hubstaff monitora i lavoratori remoti. GeoTapp sigilla operatori fisici sul campo, conforme GDPR.' },
    ...
    es: { tagline: 'Monitoreo remoto vs certificación de campo', highlight: 'Hubstaff monitorea trabajadores remotos. GeoTapp sella operadores físicos en campo, compatible con RGPD.' },
    pt: { tagline: 'Monitorização remota vs certificação no terreno', highlight: 'A Hubstaff monitoriza trabalhadores remotos. A GeoTapp sela operadores físicos no terreno, conforme o RGPD.' },
    nl: { tagline: 'Monitoring op afstand vs certificering in het veld', highlight: 'Hubstaff monitort externe werkers. GeoTapp verzegelt fysieke medewerkers op locatie - AVG-conform.' },
    da: { tagline: 'Fjernovervågning vs feltcertificering', highlight: 'Hubstaff overvåger fjernarbejdere. GeoTapp forsegler fysiske medarbejdere i marken - GDPR-kompatibel.' },
    sv: { tagline: 'Fjärrövervakning vs fältcertifiering', highlight: 'Hubstaff övervakar distansarbetare. GeoTapp förseglar fysisk personal i fält - GDPR-kompatibel.' },
  ...
  } as any,
  {
    ...
    en: { tagline: 'Attendance tracking vs verifiable proof of work', highlight: 'NoBadge records attendance. GeoTapp certifies work with anti-spoofing GPS and verifiable reports.' },
    ...
    fr: { tagline: 'Pointage vs preuve vérifiable des interventions', highlight: 'NoBadge enregistre les présences. GeoTapp certifie le travail avec GPS anti-fraude et rapports vérifiables.' },
    ...
    pt: { tagline: 'Registo de presenças vs certificação de intervenções', highlight: 'A NoBadge regista presenças. A GeoTapp sela o trabalho com GPS anti-spoofing e relatórios verificáveis.' },
    nl: { tagline: 'Aanwezigheidsregistratie vs verzegeld werkbewijs', highlight: 'NoBadge registreert aanwezigheid. GeoTapp verzegelt het werk met anti-spoofing-GPS en verifieerbare rapporten.' },
    da: { tagline: 'Fremmøderegistrering vs forseglet arbejdsbevis', highlight: 'NoBadge registrerer fremmøde. GeoTapp forsegler arbejdet med anti-spoofing-GPS og verificerbare rapporter.' },
    sv: { tagline: 'Närvaroregistrering vs förseglat arbetsbevis', highlight: 'NoBadge registrerar närvaro. GeoTapp förseglar arbetet med anti-spoofing-GPS och verifierbara rapporter.' },
  ...
  } as any,
  {
    ...
    pt: { tagline: 'Suite de RH vs prova do trabalho', highlight: 'A Zucchetti cobre todo o pessoal, da presença ao recibo. A GeoTapp produz a prova que o cliente verifica sozinho.' },
    nl: { tagline: 'HR-suite vs bewijs van het werk', highlight: 'Zucchetti dekt het hele personeelsbeheer. GeoTapp levert het bewijs dat de opdrachtgever zelf verifieert.' },
    da: { tagline: 'HR-suite vs bevis for arbejdet', highlight: 'Zucchetti dækker hele personaleadministrationen. GeoTapp laver beviset, kunden selv kontrollerer.' },
    sv: { tagline: 'HR-svit vs bevis på arbetet', highlight: 'Zucchetti täcker hela personaladministrationen. GeoTapp skapar beviset som kunden själv kontrollerar.' },
  ...
  } as any,
  {
    ...
    it: { tagline: 'Piattaforma HR vs certificazione sul campo', highlight: 'Factorial tiene in ordine ferie, assenze e cedolini. GeoTapp difende la fattura quando il committente contesta il servizio.' },
    en: { tagline: 'HR platform vs field certification', highlight: 'Factorial keeps leave, absences and payslips in order. GeoTapp defends the invoice when a client disputes the service.' },
    ...
    fr: { tagline: 'Plateforme RH vs certification terrain', highlight: 'Factorial tient congés, absences et bulletins en ordre. GeoTapp défend la facture quand le client conteste la prestation.' },
    es: { tagline: 'Plataforma de RRHH vs certificación en campo', highlight: 'Factorial mantiene en orden vacaciones, ausencias y nóminas. GeoTapp defiende la factura cuando el cliente discute el servicio.' },
    pt: { tagline: 'Plataforma de RH vs certificação no terreno', highlight: 'A Factorial mantém em ordem férias, faltas e recibos. A GeoTapp defende a fatura quando o cliente contesta o serviço.' },
    nl: { tagline: 'HR-platform vs certificering in het veld', highlight: 'Factorial houdt verlof, verzuim en loonstroken op orde. GeoTapp verdedigt de factuur als een klant de dienst betwist.' },
    da: { tagline: 'HR-platform vs feltcertificering', highlight: 'Factorial holder styr på ferie, fravær og lønsedler. GeoTapp forsvarer fakturaen, når kunden bestrider ydelsen.' },
    sv: { tagline: 'HR-plattform vs fältcertifiering', highlight: 'Factorial håller ordning på semester, frånvaro och lönebesked. GeoTapp försvarar fakturan när kunden ifrågasätter tjänsten.' },
