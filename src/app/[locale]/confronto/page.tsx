...
const COMPARISONS: Record<string, { tagline: string; highlight: string }>[] = [
  ...
  } as any,
  {
    ...
    en: { tagline: 'Cleaning software DE vs sealed field proof', highlight: 'Blink is #1 for cleaning in Germany. GeoTapp adds anti-spoofing and reports with evidentiary value.' },
    ...
    fr: { tagline: 'Logiciel nettoyage DE vs preuve vérifiable terrain', highlight: 'Blink est le n°1 du nettoyage en Allemagne. GeoTapp ajoute l\'anti-spoofing et des rapports avec valeur probante.' },
    es: { tagline: 'Software limpieza DE vs prueba verificable de campo', highlight: 'Blink es el nº1 en limpieza en Alemania. GeoTapp añade anti-spoofing e informes con valor probatorio.' },
