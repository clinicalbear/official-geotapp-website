...
const FAQ: Record<string, FaqItem[]> = {
  it: [
    ...
    { q: 'Libemax ha 200.000 download. GeoTapp è affidabile?', a: 'Libemax è un\'ottima app di rilevazione presenze con una base utenti consolidata. GeoTapp risolve un problema diverso: non solo registra le presenze ma sigilla il lavoro con prove non alterabili. Sono due categorie diverse, come confrontare un cronometro con un notaio.' },
  ...
  en: [
    ...
    { q: 'Libemax has 200,000 downloads. Is GeoTapp reliable?', a: 'Libemax is an excellent attendance tracking app with a solid user base. GeoTapp solves a different problem: it seals work with tamper-proof evidence. Two different categories, like comparing a stopwatch with a notary.' },
  ...
  es: [
    ...
    { q: 'Libemax tiene 200.000 descargas. ¿Es GeoTapp fiable?', a: 'Libemax es una excelente app de control de presencia con una base de usuarios consolidada. GeoTapp resuelve un problema distinto: sella el trabajo con pruebas inalterables. Dos categorías diferentes, como comparar un cronómetro con un notario.' },
  ...
  pt: [
    ...
    { q: 'A Libemax tem 200.000 downloads. A GeoTapp é fiável?', a: 'A Libemax é uma excelente app de registo de presenças com uma base de utilizadores consolidada. A GeoTapp resolve um problema diferente: sela o trabalho com provas inalteráveis. Duas categorias diferentes, como comparar um cronómetro com um notário.' },
  ...
  nl: [
    ...
    { q: 'Libemax heeft 200.000 downloads. Is GeoTapp betrouwbaar?', a: 'Libemax is een uitstekende app voor tijdregistratie met een stevige gebruikersbasis. GeoTapp lost een ander probleem op: het verzegelt werk met manipulatiebestendig bewijs. Twee verschillende categorieën, alsof je een stopwatch met een notaris vergelijkt.' },
  ...
  da: [
    ...
    { q: 'Libemax har 200.000 downloads. Er GeoTapp pålidelig?', a: 'Libemax er en fremragende app til tidsregistrering med et solidt brugergrundlag. GeoTapp løser et andet problem: den forsegler arbejde med beviser, der ikke kan ændres. To forskellige kategorier, som at sammenligne et stopur med en notar.' },
  ...
  sv: [
    ...
    { q: 'Libemax har 200 000 nedladdningar. Är GeoTapp pålitligt?', a: 'Libemax är en utmärkt app för tidsrapportering med en stabil användarbas. GeoTapp löser ett annat problem: den förseglar arbete med bevis som inte kan ändras. Två olika kategorier, som att jämföra ett stoppur med en notarie.' },
  ...
  nb: [
    ...
    { q: 'Libemax har 200 000 nedlastinger. Er GeoTapp pålitelig?', a: 'Libemax er en utmerket app for tidsregistrering med en solid brukerbase. GeoTapp løser et annet problem: den forsegler arbeid med bevis som ikke kan endres. To forskjellige kategorier, som å sammenligne en stoppeklokke med en notar.' },
  ...
  ru: [
    ...
    { q: 'У Libemax 200 000 загрузок. Надёжен ли GeoTapp?', a: 'Libemax, отличное приложение для учёта присутствия с устоявшейся базой пользователей. GeoTapp решает другую задачу: он запечатывает работу доказательствами, которые нельзя подделать. Это две разные категории, как сравнивать секундомер с нотариусом.' },
...
const T: Record<string, Copy> = {
  it: {
    ...
    desc: 'Libemax è l\'app di rilevazione presenze più scaricata in Italia con oltre 200.000 download. GeoTapp è un sistema di prova verificabile del lavoro con GPS anti-spoofing e report non alterabili. Due approcci fondamentalmente diversi allo stesso problema.',
    summary: 'In sintesi:',
  ...
  en: {
    ...
    desc: 'Libemax is Italy\'s most downloaded attendance app with 200,000+ downloads. GeoTapp is a verifiable proof of work system with anti-spoofing GPS and tamper-proof reports. Two fundamentally different approaches to the same problem.',
    summary: 'Bottom line:',
    ...
    geo: ['Anti-spoofing GPS: verifies the position is real','Photos sealed with cryptographic hash chain','Report with cryptographic seal and evidentiary value','The client verifies independently','Verifiable proof, not just attendance'],
  ...
  de: {
    ...
    desc: 'Libemax ist die meistgeladene Zeiterfassungs-App in Italien mit über 200.000 Downloads. GeoTapp ist ein System für versiegelte Arbeitsnachweise mit Anti-Spoofing-GPS und fälschungssicheren Berichten. Zwei grundlegend verschiedene Ansätze für dasselbe Problem.',
    summary: 'Fazit:',
  ...
  fr: {
    ...
    desc: 'Libemax est l\'application de pointage la plus téléchargée en Italie, avec plus de 200 000 téléchargements. GeoTapp est un système de preuve vérifiable du travail avec GPS anti-spoofing et rapports infalsifiables. Deux approches fondamentalement différentes du même problème.',
    summary: 'En résumé :',
  ...
  es: {
    ...
    desc: 'Libemax es la app de control de presencia más descargada de Italia, con más de 200.000 descargas. GeoTapp es un sistema de prueba verificable del trabajo con GPS anti-spoofing e informes inalterables. Dos enfoques radicalmente distintos para el mismo problema.',
    summary: 'En resumen:',
  ...
  pt: {
    ...
    desc: 'A Libemax é a app de registo de presenças mais descarregada em Itália, com mais de 200.000 downloads. A GeoTapp é um sistema de prova verificável do trabalho com GPS anti-spoofing e relatórios inalteráveis. Duas abordagens radicalmente diferentes para o mesmo problema.',
    summary: 'Em resumo:',
  ...
  nl: {
    ...
    desc: 'Libemax is de meest gedownloade tijdregistratie-app van Italië, met meer dan 200.000 downloads. GeoTapp is een systeem voor verzegeld werkbewijs met anti-spoofing-GPS en manipulatiebestendige rapporten. Twee fundamenteel verschillende benaderingen van hetzelfde probleem.',
    summary: 'Kort gezegd:',
  ...
  da: {
    ...
    desc: 'Libemax er den mest downloadede app til tidsregistrering i Italien med over 200.000 downloads. GeoTapp er et system til forseglet arbejdsbevis med anti-spoofing-GPS og rapporter, der ikke kan ændres. To grundlæggende forskellige tilgange til det samme problem.',
    summary: 'Kort sagt:',
  ...
  sv: {
    ...
    desc: 'Libemax är den mest nedladdade appen för tidsrapportering i Italien med över 200 000 nedladdningar. GeoTapp är ett system för förseglat arbetsbevis med anti-spoofing-GPS och rapporter som inte kan ändras. Två fundamentalt olika sätt att lösa samma problem.',
    summary: 'Kort sagt:',
  ...
  nb: {
    badge: 'App-sammenligning', h1sub: 'geofence eller anti-spoofing?',
    desc: 'Libemax er den mest nedlastede appen for tidsregistrering i Italia med over 200 000 nedlastinger. GeoTapp er et system for forseglet arbeidsbevis med anti-spoofing-GPS og rapporter som ikke kan endres. To grunnleggende forskjellige tilnærminger til det samme problemet.',
    summary: 'Kort sagt:',
