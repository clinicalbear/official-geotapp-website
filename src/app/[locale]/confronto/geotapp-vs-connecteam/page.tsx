...
const FAQ: Record<string, FaqItem[]> = {
  ...
  de: [
    ...
    { q: 'Kann ich GeoTapp zusammen mit Connecteam nutzen?', a: 'Ja. GeoTapp konzentriert sich auf die versiegelter Nachweis von Einsätzen und die Erstellung verifizierbarer Beweise; Connecteam kann weiterhin interne Kommunikation und Planung übernehmen. Die beiden Tools lösen unterschiedliche Probleme.' },
  ],
  fr: [
...
const T: Record<string, Copy> = {
  it: {
    ...
    summary: 'In sintesi:',
    summaryText: 'Se hai bisogno di dimostrare al cliente che il lavoro è stato fatto, con prove GPS verificabili, report non alterabili e foto con timestamp - GeoTapp è lo strumento giusto. Connecteam non produce prove verificabili: è un tool di comunicazione e scheduling, non di prova verificabile.',
  ...
  en: {
    ...
    summary: 'Bottom line:',
    summaryText: 'If you need to prove to clients that work was completed, with verifiable GPS evidence, tamper-proof reports and timestamped photos - GeoTapp is the right tool. Connecteam does not produce verifiable proof: it\'s a communication and scheduling tool, not a verifiable proof platform.',
  ...
  de: {
    ...
    desc: 'Connecteam verwaltet die Team-Kommunikation. GeoTapp versiegelt die geleistete Arbeit mit verifizierbaren Beweisen. Zwei verschiedene Werkzeuge, hier ist der Grund.',
    summary: 'Fazit:',
    summaryText: 'Wenn Sie dem Kunden beweisen müssen, dass die Arbeit erledigt wurde, mit verifizierbaren GPS-Beweisen, fälschungssicheren Berichten und Fotos mit Zeitstempel, ist GeoTapp das richtige Werkzeug. Connecteam erstellt keine verifizierbaren Beweise: Es ist ein Tool für Kommunikation und Planung, keine Plattform für versiegelte Nachweise.',
  ...
  es: {
    ...
    summary: 'En resumen:',
    summaryText: 'Si necesitas demostrar al cliente que el trabajo se ha hecho, con pruebas GPS verificables, informes inalterables y fotos con marca temporal - GeoTapp es la herramienta adecuada. Connecteam no produce pruebas verificables: es una herramienta de comunicación y planificación, no de prueba verificable.',
  ...
  pt: {
    ...
    summary: 'Em resumo:',
    summaryText: 'Se precisa de provar ao cliente que o trabalho foi feito, com provas GPS verificáveis, relatórios inalteráveis e fotos com marca temporal, a GeoTapp é a ferramenta certa. A Connecteam não produz provas verificáveis: é uma ferramenta de comunicação e planeamento, não de prova verificável.',
  ...
  nl: {
    ...
    summary: 'Kort gezegd:',
    summaryText: 'Als je aan de klant moet bewijzen dat het werk is gedaan, met verifieerbaar GPS-bewijs, manipulatiebestendige rapporten en foto\'s met tijdstempel, is GeoTapp de juiste tool. Connecteam produceert geen verifieerbaar bewijs: het is een tool voor communicatie en planning, geen platform voor verzegeld bewijs.',
  ...
  sv: {
    ...
    summary: 'Kort sagt:',
    summaryText: 'Om du behöver bevisa för kunden att arbetet är utfört, med verifierbara GPS-bevis, rapporter som inte kan ändras och foton med tidsstämpel, är GeoTapp rätt verktyg. Connecteam producerar inte verifierbara bevis: det är ett verktyg för kommunikation och schemaläggning, inte en bevisplattform.',
  ...
  nb: {
    ...
    summary: 'Kort sagt:',
    summaryText: 'Hvis du må bevise overfor kunden at arbeidet er utført, med verifiserbare GPS-bevis, rapporter som ikke kan endres, og bilder med tidsstempel, er GeoTapp riktig verktøy. Connecteam produserer ikke verifiserbare bevis: det er et verktøy for kommunikasjon og planlegging, ikke en bevisplattform.',
