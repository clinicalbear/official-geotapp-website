...
const T: Record<string, Copy> = {
  ...
  de: {
    ...
    summary: 'Fazit:',
    summaryText: 'Wenn Sie dem Kunden überprüfbare Nachweise der Arbeit vorlegen müssen, mit verifizierbaren GPS-Beweisen, Berichten, bei denen jede Änderung erkennbar ist, und Fotos mit Zeitstempel, ist GeoTapp das richtige Werkzeug. Connecteam erstellt keine verifizierbaren Beweise: Es ist ein Tool für Kommunikation und Planung, keine Plattform für versiegelte Nachweise.',
    ...
    geo: ['Jeder Einsatz erzeugt einen versiegelten GPS- und Foto-Bericht','Der Auftraggeber prüft die Echtheit des Berichts selbst','Die Daten sind kryptographisch signiert, jede Änderung ist erkennbar','Entwickelt, um Streitigkeiten mit belastbaren Beweisen zu lösen','DSGVO-konform für die Geolokalisierung von Mitarbeitern'],
