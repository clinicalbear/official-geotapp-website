...
const META: Record<string, { title: string; description: string }> = {
  ...
  en: { title: 'GeoTapp vs Clockify - Comparison 2026 | GeoTapp', description: 'GeoTapp vs Clockify: key differences for field service companies. Clockify tracks hours; GeoTapp seals every job with verified GPS, photos and tamper-proof reports.' },
  ...
  fr: { title: 'GeoTapp vs Clockify - Comparaison 2026 | GeoTapp', description: 'GeoTapp vs Clockify : différences clés pour les entreprises avec des opérateurs sur le terrain. Clockify suit les heures ; GeoTapp scelle chaque intervention avec GPS vérifié, photos et rapports infalsifiables.' },
