...
const META: Record<string, { title: string; description: string }> = {
  ...
  es: { title: 'GeoTapp vs Clockify - Comparación 2026 | GeoTapp', description: 'GeoTapp vs Clockify: diferencias clave para empresas con operarios de campo. Clockify registra las horas; GeoTapp sella cada intervención con GPS verificado, fotos e informes cuya modificación es detectable.' },
  pt: { title: 'GeoTapp vs Clockify - Comparação 2026 | GeoTapp', description: 'GeoTapp vs Clockify: diferenças-chave para empresas com operadores no terreno. A Clockify regista as horas; a GeoTapp sela cada intervenção com GPS verificado, fotos e relatórios cuja alteração é detetável.' },
  da: { title: 'GeoTapp vs Clockify - Sammenligning 2026 | GeoTapp', description: 'GeoTapp vs Clockify: vigtige forskelle for virksomheder med medarbejdere i marken. Clockify registrerer timer; GeoTapp forsegler hver opgave med verificeret GPS, fotos og rapporter hvor enhver ændring kan opdages.' },
  sv: { title: 'GeoTapp vs Clockify - Jämförelse 2026 | GeoTapp', description: 'GeoTapp vs Clockify: viktiga skillnader för företag med fältpersonal. Clockify registrerar timmar; GeoTapp förseglar varje uppdrag med verifierad GPS, foton och rapporter där varje ändring är spårbar.' },
...
const FAQ: Record<string, FaqItem[]> = {
  ...
  de: [
    ...
    { q: 'Hat Clockify GPS-Tracking für Außendienstmitarbeiter?', a: 'Clockify hat kein verifiziertes GPS-System für Außendienstkräfte. Der Standort ist nicht Teil des Berichts und nicht kryptographisch versiegelt. GeoTapp erfasst die GPS-Position bei Öffnung und Abschluss jedes Einsatzes, eingebettet im Bericht, in dem jede Änderung erkennbar ist.' },
  ...
  fr: [
    ...
    { q: 'Clockify a-t-il un suivi GPS pour les travailleurs sur le terrain ?', a: 'Clockify n\'a pas de système GPS vérifié pour les opérateurs sur le terrain. La position ne fait pas partie du rapport et n\'est pas scellée cryptographiquement. GeoTapp enregistre la position GPS à l\'ouverture et à la clôture de chaque intervention, incluse dans le rapport, dont toute modification est détectable.' },
  ...
  nl: [
    ...
    { q: 'Heeft Clockify GPS-tracking voor buitendienstmedewerkers?', a: 'Clockify heeft geen geverifieerd GPS-systeem voor buitendienstmedewerkers. De locatie maakt geen deel uit van het rapport en is niet cryptografisch verzegeld. GeoTapp registreert de GPS-positie bij het openen en sluiten van elke opdracht, opgenomen in het rapport waarvan elke wijziging detecteerbaar is.' },
...
const T: Record<string, Copy> = {
  ...
  de: {
    ...
    diff: 'Zeiterfassung vs versiegelter Arbeitsnachweis',
  ...
  pt: {
    badge: 'Comparativo de apps', h1sub: 'registar as horas ou selar as intervenções?',
  ...
  nl: {
    ...
    diff: 'Tijdregistratie vs verzegeld bewijs van werk',
  ...
  da: {
    ...
    diff: 'Tidsregistrering vs forseglet bevis for arbejde',
  ...
  sv: {
    ...
    diff: 'Tidsregistrering vs förseglat bevis för arbete',
