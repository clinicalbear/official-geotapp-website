...
const META: Record<string, { title: string; description: string }> = {
  ...
  da: {
    title: 'Sammenlign GeoTapp med Connecteam, Hubstaff, Jibble og flere - Dynamisk sammenligning',
    description: 'Sammenlign GeoTapp med de vigtigste field service-konkurrenter i realtid. 12 funktioner, 7 værktøjer, én tabel.',
  },
  sv: {
    title: 'Jämför GeoTapp med Connecteam, Hubstaff, Jibble och fler - Dynamisk jämförelse',
    description: 'Jämför GeoTapp med de viktigaste field service-konkurrenterna i realtid. 12 funktioner, 7 verktyg, en tabell.',
  },
  nb: {
    title: 'Sammenlign GeoTapp med Connecteam, Hubstaff, Jibble og flere - Dynamisk sammenligning',
    description: 'Sammenlign GeoTapp med de viktigste field service-konkurrentene i sanntid. 12 funksjoner, 7 verktøy, én tabell.',
  },
  ru: {
    title: 'Сравните GeoTapp с Connecteam, Hubstaff, Jibble и другими - Динамическое сравнение',
    description: 'Сравните GeoTapp с основными конкурентами в сфере выездного обслуживания в реальном времени. 12 функций, 7 инструментов, одна таблица.',
  },
};
...
const COPY: Record<string, Copy> = {
  ...
  da: {
    ...
    title: 'GeoTapp vs resten af markedet',
    subtitle: 'Vælg en konkurrent i menuen, se sammenligningen på 12 nøglefunktioner. Reelle tal, intet marketing-fluff.',
    breadcrumbHome: 'Hjem',
    breadcrumbCompare: 'Sammenligninger',
    breadcrumbDynamic: 'Dynamisk sammenligning',
    chooseCompetitor: 'Vælg konkurrenten, der skal sammenlignes',
    geotappCol: 'GeoTapp',
    featureCol: 'Funktion',
    pricingLabel: 'Fra {eur}€/bruger/måned',
    pricingTrial: '14 dages trial, intet kort',
    ...
    differenceText: 'Alle konkurrenter registrerer timer og position. Kun GeoTapp laver en kryptografisk forseglet rapport, som din kunde kan verificere uafhængigt.',
  },
  sv: {
    badge: 'Dynamisk jämförelse',
    title: 'GeoTapp vs resten av marknaden',
    subtitle: 'Välj en konkurrent i menyn, se jämförelsen på 12 nyckelfunktioner. Riktiga siffror, inget marknadsföringssnack.',
    breadcrumbHome: 'Hem',
    breadcrumbCompare: 'Jämförelser',
    breadcrumbDynamic: 'Dynamisk jämförelse',
    chooseCompetitor: 'Välj konkurrenten att jämföra',
    geotappCol: 'GeoTapp',
    featureCol: 'Funktion',
    pricingLabel: 'Från {eur}€/användare/månad',
    pricingTrial: '14 dagars trial, inget kort',
    visitWebsite: 'Besök webbplatsen',
    ctaTitle: 'Prova det själv i 14 dagar',
    ctaDesc: 'Skillnaden syns vid första dokumenterade uppdraget. Inget kort krävs.',
    ctaBtn: 'Starta gratis trial →',
    keyDifference: 'Den avgörande skillnaden',
    differenceText: 'Alla konkurrenter registrerar timmar och position. Bara GeoTapp skapar en kryptografiskt förseglad rapport som din kund kan verifiera oberoende.',
  },
  nb: {
    badge: 'Dynamisk sammenligning',
    title: 'GeoTapp vs resten av markedet',
    subtitle: 'Velg en konkurrent fra menyen, se sammenligningen på 12 nøkkelfunksjoner. Reelle tall, ingen markedsføringsprat.',
    breadcrumbHome: 'Hjem',
    breadcrumbCompare: 'Sammenligninger',
    breadcrumbDynamic: 'Dynamisk sammenligning',
    chooseCompetitor: 'Velg konkurrenten du vil sammenligne',
    geotappCol: 'GeoTapp',
    featureCol: 'Funksjon',
    pricingLabel: 'Fra {eur}€/bruker/måned',
    pricingTrial: '14 dagers trial, uten kort',
    ...
    differenceText: 'Alle konkurrenter registrerer timer og posisjon. Bare GeoTapp lager en kryptografisk forseglet rapport som kunden din kan verifisere uavhengig.',
  },
  ru: {
    badge: 'Динамическое сравнение',
    title: 'GeoTapp против остального рынка',
    subtitle: 'Выберите конкурента из меню и сравните по 12 ключевым функциям. Реальные данные, без маркетинговой воды.',
    ...
    pricingTrial: '14 дней пробного периода, без карты',
    ...
    differenceText: 'Все конкуренты фиксируют часы и местоположение. Только GeoTapp создаёт криптографически запечатанный отчёт, который ваш клиент может проверить независимо.',
  },
};
