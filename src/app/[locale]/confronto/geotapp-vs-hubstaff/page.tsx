...
const FAQ: Record<string, FaqItem[]> = {
  it: [
    { q: 'Qual è la differenza principale tra GeoTapp e Hubstaff?', a: 'Hubstaff è un sistema di monitoraggio della produttività per lavoratori remoti: traccia il GPS e cattura screenshot. GeoTapp è un sistema di prova verificabile degli interventi: produce report sigillati con GPS verificato e prove fotografiche che il committente verifica autonomamente. Orientamenti molto diversi.' },
  ...
  de: [
    { q: 'Was ist der Hauptunterschied zwischen GeoTapp und Hubstaff?', a: 'Hubstaff ist ein Produktivitäts-Überwachungssystem für Remote-Mitarbeiter: es trackt GPS und erstellt Screenshots. GeoTapp ist ein Einsatz-System für versiegelte Nachweise: es erzeugt versiegelte Berichte mit verifiziertem GPS und Fotobeweise, die der Auftraggeber selbstständig prüft. Sehr unterschiedliche Ausrichtungen.' },
  ...
  nl: [
    { q: 'Wat is het belangrijkste verschil tussen GeoTapp en Hubstaff?', a: 'Hubstaff is een systeem voor productiviteitsmonitoring van externe medewerkers: het volgt GPS en maakt schermafbeeldingen. GeoTapp is een systeem voor het verzegelen van opdrachten: het produceert verzegelde rapporten met geverifieerd GPS en fotobewijs dat de opdrachtgever zelfstandig verifieert. Heel verschillende oriëntaties.' },
...
const T: Record<string, Copy> = {
  it: {
    ...
    summary: 'In sintesi:',
    summaryText: 'Hubstaff è pensato per monitorare lavoratori remoti digitali (screenshot, produttività). GeoTapp è pensato per sigillare operatori fisici sul campo: report in cui qualsiasi modifica risulta evidente, con GPS reale, prove fotografiche e verifica indipendente da parte del committente. Inoltre, Hubstaff pone questioni di conformità GDPR nel contesto italiano che GeoTapp risolve per design.',
    ...
    geo: ['Report sigillato: prova difendibile per il committente','GPS verificato solo durante l\'intervento attivo','Conforme GDPR e Garante Privacy italiano','Progettato per settori operativi italiani (pulizie, manutenzione, sicurezza)','L\'operatore non è sorvegliato, il lavoro è sigillato'],
    comp: ['Progettato per monitorare lavoratori remoti digitali','GPS continuo e screenshot automatici','Conformità GDPR da verificare nel contesto italiano','Nessun report verificabile dal committente','Orientamento alla produttività, non alla prova verificabile'],
  ...
  en: {
    ...
    geo: ['Sealed report: defensible proof for the client','GPS verified only during active job','GDPR and Italian Privacy Authority compliant','Designed for Italian operational sectors (cleaning, maintenance, security)','Operator is not surveilled, work is sealed'],
    comp: ['Designed to monitor digital remote workers','Continuous GPS and automatic screenshots','GDPR compliance to verify in Italian context','No reports verifiable by the client','Productivity-focused, not verifiable-proof-focused'],
  ...
  de: {
    badge: 'App-Vergleich', h1sub: 'Versiegelung oder Überwachung?',
    desc: 'Hubstaff überwacht Remote-Mitarbeiter mit Screenshots und GPS. GeoTapp versiegelt jeden Einsatz mit vom Auftraggeber prüfbaren Beweisen. Unterschiedliche Ausrichtungen, unterschiedliche Branchen.',
    summary: 'Fazit:',
    summaryText: 'Hubstaff ist darauf ausgelegt, digitale Remote-Mitarbeiter zu überwachen (Screenshots, Produktivität). GeoTapp ist darauf ausgelegt, physische Außendienstmitarbeiter zu versiegeln: Berichte, bei denen jede Änderung erkennbar ist, mit echtem GPS, Fotobeweise und unabhängige Prüfung durch den Auftraggeber. Außerdem wirft Hubstaff im italienischen Kontext Fragen zur DSGVO-Konformität auf, die GeoTapp durch sein Design löst.',
    ...
    geo: ['Versiegelter Bericht: belastbarer Beweis für den Auftraggeber','GPS nur während des aktiven Einsatzes verifiziert','DSGVO- und ital. Datenschutzbehörde-konform','Entwickelt für ital. Einsatzbranchen (Reinigung, Wartung, Sicherheit)','Der Mitarbeiter wird nicht überwacht, die Arbeit wird versiegelt'],
    comp: ['Entwickelt zur Überwachung digitaler Remote-Mitarbeiter','Kontinuierliches GPS und automatische Screenshots','DSGVO-Konformität im ital. Kontext zu prüfen','Keine vom Auftraggeber prüfbaren Berichte','Produktivitätsorientiert, nicht auf verifizierbare Nachweise ausgerichtet'],
  ...
  fr: {
    badge: 'Comparatif d\'applis', h1sub: 'scellé ou surveillance ?',
    ...
    geo: ['Rapport scellé : preuve défendable pour le client','GPS vérifié uniquement pendant l\'intervention active','Conforme RGPD et autorité italienne de protection des données','Conçu pour les secteurs opérationnels italiens (nettoyage, maintenance, sécurité)','L\'intervenant n\'est pas surveillé, le travail est scellé'],
    comp: ['Conçu pour surveiller des travailleurs numériques à distance','GPS continu et captures d\'écran automatiques','Conformité RGPD à vérifier dans le contexte italien','Aucun rapport vérifiable par le client','Orienté productivité, pas preuve vérifiable'],
  ...
  nl: {
    badge: 'App-vergelijking', h1sub: 'verzegeling of monitoring?',
    desc: 'Hubstaff monitort externe medewerkers met schermafbeeldingen en GPS. GeoTapp verzegelt elke opdracht met door de klant verifieerbaar bewijs. Verschillende oriëntaties, verschillende sectoren.',
    summary: 'Kort gezegd:',
    summaryText: 'Hubstaff is bedoeld om digitale externe medewerkers te monitoren (schermafbeeldingen, productiviteit). GeoTapp is bedoeld om fysieke buitendienstmedewerkers te verzegelen: rapporten waarvan elke wijziging detecteerbaar is, met echte GPS, fotobewijs en onafhankelijke verificatie door de klant. Bovendien werpt Hubstaff in de Italiaanse context vragen op over AVG-conformiteit die GeoTapp door zijn ontwerp oplost.',
    ...
    ctaBtn: 'Begin gratis!',
    geo: ['Verzegeld rapport: verdedigbaar bewijs voor de klant','GPS alleen geverifieerd tijdens de actieve opdracht','AVG- en Italiaanse toezichthouder-conform','Ontworpen voor Italiaanse operationele sectoren (schoonmaak, onderhoud, beveiliging)','De medewerker wordt niet bespied, het werk wordt verzegeld'],
    comp: ['Ontworpen om digitale externe medewerkers te monitoren','Continu GPS en automatische schermafbeeldingen','AVG-conformiteit te verifiëren in de Italiaanse context','Geen door de klant verifieerbare rapporten','Gericht op productiviteit, niet op verifieerbaar bewijs'],
