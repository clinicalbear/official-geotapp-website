...
const T: Record<string, Copy> = {
  ...
  pt: {
    ...
    summary: 'Em resumo:',
    summaryText: 'A Hubstaff foi pensada para vigiar trabalhadores digitais remotos (capturas de ecrã, produtividade). A GeoTapp foi pensada para selar operadores físicos no terreno: relatórios inalteráveis com GPS real, provas fotográficas e verificação independente pelo cliente. Além disso, a Hubstaff levanta questões de conformidade com o RGPD no contexto italiano que a GeoTapp resolve por conceção.',
  ...
  nl: {
    ...
    summary: 'Kort gezegd:',
    summaryText: 'Hubstaff is bedoeld om digitale externe medewerkers te monitoren (schermafbeeldingen, productiviteit). GeoTapp is bedoeld om fysieke buitendienstmedewerkers te verzegelen: manipulatiebestendige rapporten met echte GPS, fotobewijs en onafhankelijke verificatie door de klant. Bovendien werpt Hubstaff in de Italiaanse context vragen op over AVG-conformiteit die GeoTapp door zijn ontwerp oplost.',
  ...
  sv: {
    ...
    summary: 'Kort sagt:',
    summaryText: 'Hubstaff är till för att övervaka digitala distansarbetare (skärmdumpar, produktivitet). GeoTapp är till för att försegla fysisk personal ute i fält: rapporter som inte kan ändras, med äkta GPS, fotobevis och oberoende verifiering av kunden. Dessutom väcker Hubstaff i den italienska kontexten frågor om GDPR-efterlevnad som GeoTapp löser genom sin design.',
  ...
  nb: {
    ...
    summary: 'Kort sagt:',
    summaryText: 'Hubstaff er laget for å overvåke digitale fjernarbeidere (skjermbilder, produktivitet). GeoTapp er laget for å forsegle fysiske ansatte ute i felt: rapporter som ikke kan endres, med ekte GPS, fotobevis og uavhengig verifisering av oppdragsgiveren. I tillegg reiser Hubstaff i den italienske konteksten spørsmål om GDPR-samsvar som GeoTapp løser gjennom sin design.',
