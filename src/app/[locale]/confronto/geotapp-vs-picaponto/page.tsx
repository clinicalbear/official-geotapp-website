      ...
      <div className="min-h-screen pt-5 pb-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-display font-bold mb-6">GeoTapp vs PicaPonto: <span className="text-primary">{t.h1sub}</span></h1>
          ...
          <section className="mb-16">
            ...
            <div className="overflow-x-auto rounded-xl border border-white/10">
              <table className="w-full">
                <thead><tr className="border-b border-white/10 bg-white/5"><th className="text-left py-3 px-4 font-semibold text-sm">{t.feat}</th><th className="text-center py-3 px-4 font-semibold text-sm text-primary">GeoTapp</th><th className="text-center py-3 px-4 font-semibold text-sm text-text-secondary">PicaPonto</th></tr></thead>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6"><h3 className="font-semibold text-text-secondary mb-3">PicaPonto</h3><ul className="space-y-2 text-sm text-text-secondary">{t.comp.map((li, i) => <li key={i}>&bull; {li}</li>)}</ul></div>
            </div>
          </section>
          ...
          <CompareBlogLink competitor="picaponto" locale={locale} />
          <div className="text-center bg-gradient-to-br from-primary/20 to-purple-500/10 border border-primary/20 rounded-2xl p-10">
            ...
            <TrialCTALink href={`/${locale}/trial/`} source="confronto_vs_picaponto" className="btn-modern">{t.ctaBtn}</TrialCTALink>
          </div>
        </div>
      </div>
    </>
