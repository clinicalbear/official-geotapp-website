...
const FAQ: Record<string, FaqItem[]> = {
  ...
  en: [
    ...
    { q: 'Blink is #1 in Gebäudereinigung. Why choose GeoTapp?', a: 'Blink excels at time tracking and team communication for the German cleaning sector. But if you need to show your client verifiable proof of the service with tamper-evident proof, you need GeoTapp. Different tools for different problems.' },
  ],
  de: [
    { q: 'Was ist der Hauptunterschied zwischen GeoTapp und Blink?', a: 'Blink ist die führende Zeiterfassungssoftware für die deutsche Gebäudereinigung: GPS, QR-Code, NFC, Aufgabenverwaltung und Teamkommunikation. GeoTapp geht einen Schritt weiter: Es ist ein System für versiegelte Nachweise für Arbeit vor Ort, das jeden Einsatz mit Anti-Spoofing-GPS und kryptographisch versiegelten Fotos dokumentiert, bei denen jede Änderung erkennbar ist. Der Auftraggeber verifiziert den Bericht selbst, er muss Ihnen nicht glauben.' },
    ...
    { q: 'Blink ist die Nr. 1 in der Gebäudereinigung. Warum GeoTapp wählen?', a: 'Blink ist hervorragend für Zeiterfassung und Teamkommunikation in der Reinigungsbranche. Wenn Sie aber dem Auftraggeber überprüfbare Nachweise des Service vorlegen müssen, mit Fotos, bei denen jede Änderung erkennbar ist, und einem überprüfbaren Bericht, dann brauchen Sie GeoTapp. Es sind zwei verschiedene Werkzeuge für zwei verschiedene Probleme.' },
  ],
  fr: [
...
const T: Record<string, Copy> = {
  ...
  en: {
    ...
    geo: ['Anti-spoofing GPS: detects fake positions','Photos sealed with cryptographic hash chain','Report with a verifiable cryptographic seal','Client verifies independently on public portal','Not just cleaning, all field service sectors'],
  ...
  de: {
    ...
    geo: ['Anti-Spoofing-GPS: erkennt gefälschte Positionen','Fotos versiegelt mit kryptographischer Hash-Kette','Bericht mit überprüfbarem kryptographischem Siegel','Auftraggeber verifiziert selbst auf öffentlichem Portal','Nicht nur Reinigung, alle Branchen mit Außendienst'],
