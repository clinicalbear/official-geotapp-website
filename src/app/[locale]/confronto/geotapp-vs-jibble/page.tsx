...
const META: Record<string, { title: string; description: string }> = {
  ...
  nl: { title: 'GeoTapp vs Jibble - Vergelijking 2026 | GeoTapp', description: 'GeoTapp vs Jibble: belangrijke verschillen voor bedrijven met buitendienstmedewerkers. Jibble registreert aanwezigheid met gezicht en basis-GPS; GeoTapp bewijst elke opdracht met geverifieerd GPS, foto\'s en rapporten waarvan elke wijziging detecteerbaar is.' },
