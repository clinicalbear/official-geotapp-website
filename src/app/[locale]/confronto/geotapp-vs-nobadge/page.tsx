...
const FAQ: Record<string, FaqItem[]> = {
  ...
  en: [
    ...
    { q: 'GeoTapp or NoBadge for cleaning companies?', a: 'If you only need to track employee hours, NoBadge may suffice. If you need to show your client verifiable proof of the service with tamper-evident evidence, verified GPS, sealed photos, verifiable reports - GeoTapp is the only solution.' },
  ],
  de: [
    ...
    { q: 'GeoTapp oder NoBadge für Reinigungsunternehmen?', a: 'Wenn Sie nur Arbeitszeiten erfassen müssen, kann NoBadge ausreichen. Wenn Sie dem Auftraggeber überprüfbare Nachweise des Service vorlegen müssen, mit verifiziertem GPS, versiegelten Fotos und überprüfbaren Berichten, ist GeoTapp die einzige Lösung.' },
  ],
  fr: [
  ...
  es: [
    ...
    { q: '¿GeoTapp o NoBadge para empresas de limpieza?', a: 'Si el objetivo es solo registrar las horas de los empleados, NoBadge puede bastar. Si el objetivo es mostrar al cliente pruebas verificables del servicio con pruebas cuya modificación es detectable - GPS verificado, fotos selladas, informes verificables - GeoTapp es la única solución.' },
  ],
  pt: [
  ...
  nl: [
    ...
    { q: 'GeoTapp of NoBadge voor schoonmaakbedrijven?', a: 'Als het doel alleen is om de uren van werknemers te registreren, kan NoBadge volstaan. Als het doel is om de opdrachtgever verifieerbaar bewijs van de dienst te laten zien met verzegeld bewijs, geverifieerd GPS, verzegelde foto\'s, verifieerbare rapporten, is GeoTapp de enige oplossing.' },
  ],
  da: [
...
const T: Record<string, Copy> = {
  ...
  en: {
    ...
    summary: 'Bottom line:',
    summaryText: 'NoBadge is a solid attendance system for basic time tracking. GeoTapp is for companies that need to show their client verifiable proof of the work, with tamper-evident evidence, verified GPS and verifiable reports that the client can check independently.',
    ...
    comp: ['Records attendance via GPS and QR code','No anti-spoofing check on GPS position','No cryptographic photo sealing','Internal reports, not verifiable by client','HR-focused, not verifiable-proof-focused'],
  ...
  de: {
    badge: 'App-Vergleich', h1sub: 'Zeiterfassung oder versiegelter Nachweis?',
    ...
    summary: 'Fazit:',
    summaryText: 'NoBadge ist ein gutes Anwesenheitssystem für reine Zeiterfassung. GeoTapp ist für Unternehmen, die ihrem Auftraggeber überprüfbare Nachweise der Arbeit vorlegen müssen, mit versiegelten Beweisen, verifiziertem GPS und überprüfbaren Berichten, die der Auftraggeber selbst prüfen kann.',
    ...
    comp: ['Erfasst Anwesenheit per GPS und QR-Code','Keine Anti-Spoofing-Prüfung der GPS-Position','Keine kryptographische Versiegelung der Fotos','Interne Berichte, nicht vom Auftraggeber verifizierbar','HR-orientiert, nicht auf verifizierbaren Nachweis ausgerichtet'],
  ...
  fr: {
    ...
    summary: 'En résumé :',
    summaryText: 'NoBadge est un bon système de pointage pour ceux qui ont seulement besoin d\'enregistrer les entrées et les sorties. GeoTapp est pour ceux qui doivent montrer à leur donneur d\'ordre des preuves vérifiables du travail, avec des preuves scellées, un GPS vérifié et des rapports vérifiables que le client peut contrôler lui-même.',
    ...
    comp: ['Enregistre les présences par GPS et QR code','Aucun contrôle anti-spoofing sur le GPS','Aucun scellement cryptographique des photos','Rapports internes, non vérifiables par le client','Orienté gestion RH, pas preuve vérifiable'],
  ...
  es: {
    ...
    summary: 'En resumen:',
    summaryText: 'NoBadge es un buen sistema de control de presencia para quien solo necesita registrar entradas y salidas. GeoTapp es para quien necesita mostrar a su cliente pruebas verificables del trabajo, con pruebas selladas, GPS verificado e informes verificables que el cliente puede controlar por sí mismo.',
    ...
    comp: ['Registra presencias con GPS y código QR','Sin control anti-spoofing del GPS','Sin sellado criptográfico de las fotos','Informes internos, no verificables por el cliente','Orientado a la gestión de RR. HH., no a la prueba verificable'],
  ...
  nl: {
    badge: 'App-vergelijking', h1sub: 'tijdregistratie of verzegeld bewijs?',
    ...
    summary: 'Kort gezegd:',
    summaryText: 'NoBadge is een goed aanwezigheidssysteem voor wie alleen in- en uitchecken hoeft te registreren. GeoTapp is voor wie zijn opdrachtgever verifieerbaar bewijs van het werk moet laten zien, met verzegeld bewijs, geverifieerd GPS en verifieerbare rapporten die de klant zelf kan controleren.',
    ...
    comp: ['Registreert aanwezigheid via GPS en QR-code','Geen anti-spoofing-controle op het GPS','Geen cryptografische verzegeling van de foto\'s','Interne rapporten, niet verifieerbaar door de klant','Gericht op HR-beheer, niet op verifieerbaar bewijs'],
