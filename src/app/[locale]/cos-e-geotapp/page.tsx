...
const COPY: Record<string, Copy> = {
  it: {
    ...
    pricingText: 'Il modello è a licenze utente, con prezzi pubblici. GeoTapp TimeTracker parte da €4 per operatore al mese; sono disponibili piani per piccole squadre (3-10 utenti), medie imprese (10-50) e grandi organizzazioni (50-300+). Il bundle Flow + TimeTracker è scontato. GeoTapp Verifier è sempre incluso.',
  ...
  en: {
    ...
    pricingText: 'Per-user licensing with transparent pricing. GeoTapp TimeTracker starts at €4 per operator per month, with plans for small teams (3-10 users), medium businesses (10-50) and large organisations (50-300+). The Flow + TimeTracker bundle is discounted. GeoTapp Verifier is always included.',
  ...
  de: {
    ...
    pricingText: 'Lizenzmodell pro Benutzer mit transparenten Preisen. GeoTapp TimeTracker beginnt bei €4 pro Mitarbeiter pro Monat, mit Plänen für kleine Teams (3-10 Benutzer), mittlere Unternehmen (10-50) und große Organisationen (50-300+). Flow + TimeTracker Bundle mit Rabatt. GeoTapp Verifier ist immer enthalten.',
  ...
  fr: {
    ...
    pricingText: 'Modèle de licence par utilisateur avec tarifs transparents. GeoTapp TimeTracker à partir de 4 €/opérateur/mois, plans pour petites équipes (3-10 utilisateurs), PME (10-50) et grandes organisations (50-300+). Le bundle Flow + TimeTracker est remisé. GeoTapp Verifier toujours inclus.',
  ...
  es: {
    ...
    pricingText: 'Modelo de licencia por usuario con precios transparentes. GeoTapp TimeTracker desde 4 €/operario/mes, con planes para equipos pequeños (3-10 usuarios), pymes (10-50) y grandes organizaciones (50-300+). Bundle Flow + TimeTracker con descuento. GeoTapp Verifier siempre incluido.',
  ...
  pt: {
    ...
    pricingText: 'Modelo de licenciamento por utilizador com preços transparentes. GeoTapp TimeTracker a partir de 4 €/operador/mês, com planos para equipas pequenas (3-10 utilizadores), PMEs (10-50) e grandes organizações (50-300+). Bundle Flow + TimeTracker com desconto. GeoTapp Verifier sempre incluído.',
  ...
  da: {
    ...
    pricingText: 'Licensmodel pr. bruger med gennemsigtige priser. GeoTapp TimeTracker fra €4 pr. medarbejder pr. måned, med planer for små teams (3-10 brugere), SMV\'er (10-50) og store organisationer (50-300+). Flow + TimeTracker bundle med rabat. GeoTapp Verifier altid inkluderet.',
    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 py-12 sm:py-16">
        ...
        <section className="mb-12 rounded-2xl bg-gradient-to-br from-green-50 to-blue-50 border border-slate-200 p-8 text-center">
          ...
          <Link
            href={trialHref}
            className="inline-block bg-[#8FC436] text-white font-bold px-8 py-4 rounded-xl text-lg hover:bg-[#7AB02A] transition-colors"
          >
            {copy.trialCta} →
          </Link>
        </section>
