...
const FLOW_FAQ: Record<string, object> = {
  it: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'GeoTapp Flow mostra dove sono i tecnici in tempo reale?', acceptedAnswer: { '@type': 'Answer', text: 'No, e non è una dimenticanza. La posizione si registra solo all\'apertura e alla chiusura dell\'intervento, non in continuo: Flow ti dice che il lavoro è iniziato sul posto giusto e a che ora, non ti fa seguire un pallino sulla mappa tutto il giorno. È la differenza tra prova del lavoro e sorveglianza.' } },
  ...
  de: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Zeigt GeoTapp Flow in Echtzeit, wo die Techniker sind?', acceptedAnswer: { '@type': 'Answer', text: 'Nein, und das ist Absicht. Der Standort wird nur bei Beginn und Abschluss eines Auftrags erfasst, nicht durchgehend: Flow zeigt, dass die Arbeit am richtigen Ort und zur richtigen Zeit begonnen hat, statt einen Punkt auf der Karte den ganzen Tag zu verfolgen. Das ist der Unterschied zwischen Arbeitsnachweis und Überwachung.' } },
      { '@type': 'Question', name: 'Für welche Unternehmen ist GeoTapp Flow gedacht?', acceptedAnswer: { '@type': 'Answer', text: 'Für Betriebe mit Teams im Außeneinsatz: Reinigung, Sicherheit, Wartung, Installateure, Elektriker, Klempner und Multiservice. Wenn Ihre Mitarbeiter den Tag im Feld statt am Schreibtisch verbringen, ist Flow dafür gemacht.' } },
      { '@type': 'Question', name: 'Wie weise ich Aufträge in GeoTapp Flow den Teams zu?', acceptedAnswer: { '@type': 'Answer', text: 'Sie erstellen den Auftrag im Büro, weisen den Techniker oder das Team zu, und der Mitarbeiter findet ihn in der TimeTracker-App. Nach Abschluss kommt der Bericht zurück in Flow, bereits überprüfbar, ohne jemandem hinterherzulaufen.' } },
    ],
  },
};
