...
const APP_FAQ: Record<string, object> = {
  ...
  sv: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Hur skiljer sig GeoTapp TimeTracker från en vanlig app för tidsrapportering?', acceptedAnswer: { '@type': 'Answer', text: 'GeoTapp TimeTracker är inte bara tidsrapportering: varje stämpling förseglas med verklig GPS, kryptografisk hash och fotobevis. Rapporten kan verifieras oberoende och kan inte ändras, inte ens av administratören.' } },
