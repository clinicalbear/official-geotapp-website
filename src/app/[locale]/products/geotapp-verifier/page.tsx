...
const VERIFIER_FAQ: Record<string, object> = {
  ...
  en: {
    ...
    '@type': 'FAQPage',
    mainEntity: [
      { '@type': 'Question', name: 'How does GeoTapp Verifier report verification work?', acceptedAnswer: { '@type': 'Answer', text: 'Every GeoTapp report is sealed with a cryptographic hash when closed. The client receives a unique link and can independently verify at geotapp.com/verifica/ that GPS data, photos and timestamps have not been modified after creation.' } },
