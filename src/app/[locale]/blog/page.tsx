...
async function fetchBlogPosts(locale: string): Promise<WpPost[]> {
  try {
    const res = await fetch(
      `https://blog.geotapp.com/wp-json/wp/v2/posts/?per_page=12&_fields=id,slug,title,excerpt,date,link&lang=${locale}&status=publish`,
      {
        headers: {
