          ...
          <script
            ...
            dangerouslySetInnerHTML={{ __html: JSON.stringify({
              ...
              mainEntity: [
                {
                  '@type': 'Question',
                  name: 'How does GeoTapp GPS attendance tracking work?',
                  acceptedAnswer: { '@type': 'Answer', text: 'The operator opens and closes their shift from the mobile app. GeoTapp records the real GPS coordinates at that moment — not entered manually. Every clock-in is certified with a timestamp and position verifiable by anyone.' },
                },
                {
                  '@type': 'Question',
                  name: 'Is GeoTapp GDPR compliant for employee geolocation?',
                  acceptedAnswer: { '@type': 'Answer', text: 'Yes. GeoTapp records location only during active work sessions — at clock-in and clock-out. No continuous tracking. The platform includes employee disclosure templates and collects no unnecessary data.' },
                },
                {
                  '@type': 'Question',
                  name: 'What does a GeoTapp report contain?',
                  acceptedAnswer: { '@type': 'Answer', text: 'Each report includes: start and end timestamps, verified GPS coordinates, photo evidence with cryptographic hash, operator data and a digital seal. The report cannot be modified after generation — any change breaks the seal.' },
                },
                {
                  '@type': 'Question',
                  name: 'Does GeoTapp work for cleaning companies, installers and security services?',
                  acceptedAnswer: { '@type': 'Answer', text: 'Yes. GeoTapp is used by cleaning companies, facility services, installers and security services. The platform scales from 3 to 300 operators and manages multiple sites simultaneously.' },
                },
                {
                  '@type': 'Question',
                  name: 'How does a client verify a GeoTapp report?',
                  acceptedAnswer: { '@type': 'Answer', text: 'The client receives a unique link and can verify the report at geotapp.com/verifica/ without accessing your account. The system compares the cryptographic seal and confirms the data has not been modified.' },
                },
              ],
            }) }}
          />
          ...
          <script
            ...
            dangerouslySetInnerHTML={{ __html: JSON.stringify({
              ...
              mainEntity: [
                {
                  '@type': 'Question',
                  name: 'Wie funktioniert die GPS-Anwesenheitserfassung von GeoTapp?',
                  acceptedAnswer: { '@type': 'Answer', text: 'Der Mitarbeiter öffnet und schließt seine Schicht über die mobile App. GeoTapp erfasst die echten GPS-Koordinaten in diesem Moment — nicht manuell eingegeben. Jede Zeiterfassung wird mit einem verifizierbaren Zeitstempel und Standort zertifiziert.' },
                },
                {
                  '@type': 'Question',
                  name: 'Ist GeoTapp DSGVO-konform für die Mitarbeitergeolokalisierung?',
                  acceptedAnswer: { '@type': 'Answer', text: 'Ja. GeoTapp erfasst den Standort nur beim Ein- und Ausstempeln — kein kontinuierliches Tracking. Die Plattform enthält Vorlagen für die Mitarbeiterinformation und erfasst keine unnötigen Daten. Konform mit den DSGVO-Anforderungen.' },
                },
                {
                  '@type': 'Question',
                  name: 'Was enthält ein GeoTapp-Bericht?',
                  acceptedAnswer: { '@type': 'Answer', text: 'Jeder Bericht enthält: Start- und Endzeitstempel, verifizierte GPS-Koordinaten, Fotobelege mit kryptographischem Hash, Mitarbeiterdaten und ein digitales Siegel. Der Bericht ist nach der Erstellung nicht mehr änderbar — jede Änderung bricht das Siegel.' },
                },
                {
                  '@type': 'Question',
                  name: 'Funktioniert GeoTapp für Reinigungsunternehmen, Installateure und Sicherheitsdienste?',
                  acceptedAnswer: { '@type': 'Answer', text: 'Ja. GeoTapp wird von Reinigungsunternehmen, Facility-Services, Installateuren und Sicherheitsdiensten eingesetzt. Die Plattform skaliert von 3 bis 300 Mitarbeitern und verwaltet mehrere Standorte gleichzeitig.' },
                },
                {
                  '@type': 'Question',
                  name: 'Wie kann ein Kunde einen GeoTapp-Bericht verifizieren?',
                  acceptedAnswer: { '@type': 'Answer', text: 'Der Kunde erhält einen eindeutigen Link und kann den Bericht auf geotapp.com/verifica/ ohne Zugang zu Ihrem Konto prüfen. Das System vergleicht das kryptographische Siegel und bestätigt, dass die Daten nicht verändert wurden.' },
                },
              ],
            }) }}
          />
