...
export const LINK_BREVI: Record<string, LinkBreve> = {
  ...
  'fb-selvstendig': { destinazione: '/nb/survey/', nota: 'FB Selvstendig Naeringsdrivende' },
  ...
  'li-fseng': { destinazione: '/en/survey/', nota: 'LI Field Service / Customer Support Engineer' },
