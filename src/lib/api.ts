...
export async function getHomepageData() {
  try {
    ...
    return {
      ...
      hero_subtitle:
        "GeoTapp è la soluzione completa per la gestione delle presenze in mobilità. Geolocalizzazione, reportistica avanzata e conformità GDPR in un'unica app.",
      ...
      features_subtitle:
        'Funzionalità progettate per semplificare il lavoro di HR e dipendenti.',
      features: [
        {
          id: 1,
          icon: 'map-pin',
          title: 'Geolocalizzazione',
          description: 'Verifica la posizione delle timbrature in tempo reale.',
        },
        {
          id: 2,
          icon: 'smartphone',
          title: 'App Mobile',
          description: 'Timbratura facile da smartphone iOS e Android.',
        },
        {
          id: 3,
          icon: 'bar-chart-2',
          title: 'Reportistica',
          description:
            'Export dati compatibile con i principali software paghe.',
        },
      ],
      cta_title: 'Pronto a semplificare la gestione presenze?',
      cta_subtitle:
        'Unisciti a centinaia di aziende che usano GeoTapp ogni giorno.',
