...
export const croazia: SchedaPaese = {
  ...
  checklist: [
    {
      ...
      dettaglio: {
        ...
        de: 'Wenn die Geräte alle Bewegungen des Arbeitnehmers während der gesamten Arbeitszeit verfolgen, darf der Arbeitgeber sie nur mit vorheriger Zustimmung des Betriebsrats (oder des Gewerkschaftsvertreters mit den entsprechenden Befugnissen) einsetzen. Dies gilt, wo ein solches Gremium besteht.',
        fr: "Si les dispositifs suivent tous les mouvements du travailleur pendant toute la durée du travail, l'employeur ne peut les utiliser qu'avec le consentement préalable du conseil des travailleurs (ou du représentant syndical disposant des pouvoirs correspondants). Cela vaut la ou un tel organe existe.",
        es: 'Si los dispositivos siguen todos los movimientos del trabajador durante toda la jornada, el empresario solo puede utilizarlos con el consentimiento previo del consejo de trabajadores (o del representante sindical con las facultades correspondientes). Rige allí donde dicho órgano existe.',
    ...
    },
    {
      voce: {
        ...
        fr: "Information écrite du travailleur a l'embauche et règles internes écrites (art. 43 + AZOP)",
        es: 'Información escrita al trabajador en la contratación y normas internas escritas (art. 43 + AZOP)',
      ...
      dettaglio: {
        ...
        de: 'Der Arbeitgeber muss den Arbeitnehmer bereits bei der Einstellung schriftlich darüber informieren, dass er überwacht wird, und das GPS mit schriftlichen internen Regeln regeln: eine mündliche Information genügt nicht.',
        fr: "L'employeur doit informer le travailleur par écrit, des l'embauche, qu'il sera surveille, et encadrer le GPS par des règles internes écrites: une information orale ne suffit pas.",
        es: 'El empresario debe informar al trabajador por escrito, ya en la contratación, de que será vigilado, y regular el GPS con normas internas escritas: una información oral no basta.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        es: 'No se necesita una autorización previa de la AZOP; el responsable evalúa por si mismo la base jurídica y la EIPD.',
    ...
    },
    {
      voce: {
        ...
        de: 'Grundlage = berechtigtes Interesse (nicht die Einwilligung) und Verhältnismäßigkeit; keine Ortung außerhalb der Arbeitszeit ohne Grundlage',
        fr: "Base = intérêt légitime (et non le consentement) et proportionnalité; pas de suivi en dehors des heures de travail sans base",
        es: 'Base = interés legítimo (no el consentimiento) y proporcionalidad; nada de rastreo fuera del horario sin base',
      ...
      dettaglio: {
        ...
        de: 'Die Grundlage ist in der Regel das berechtigte Interesse, nicht die Einwilligung des Arbeitnehmers (Machtungleichgewicht); die Verarbeitung muss verhältnismäßig sein und darf sich ohne klare Grundlage nicht über die Arbeitszeit hinaus erstrecken.',
        fr: "La base est normalement l'intérêt légitime, et non le consentement du travailleur (déséquilibre de pouvoir); le traitement doit être proportionné et ne pas s'étendre au-delà des heures de travail sans base claire.",
        es: 'La base es por lo general el interés legítimo, no el consentimiento del trabajador (desequilibrio de poder); el tratamiento debe ser proporcionado y no extenderse fuera del horario sin una base clara.',
    ...
    },
    {
      voce: {
        ...
        fr: "Analyse d'impact (AIPD) pour les systèmes de suivi des salaries (liste AZOP)",
      ...
      dettaglio: {
        ...
        fr: "La liste AZOP inclut le traitement des données des salaries au moyen d'applications ou de systèmes de suivi (du travail, des mouvements, de la communication) parmi ceux qui requièrent une analyse d'impact.",
  ...
  procedura: [
    {
      ...
      descrizione: {
        ...
        de: 'Wenn die Überwachung alle Bewegungen während der gesamten Arbeitszeit verfolgt, holen Sie die Zustimmung des Betriebsrats ein (ZZR Art. 43).',
        fr: "Si la surveillance suit tous les mouvements pendant toute la durée du travail, obtenez le consentement du conseil des travailleurs (ZZR art. 43).",
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Ermitteln Sie eine gültige Rechtsgrundlage (in der Regel das berechtigte Interesse) und dokumentieren Sie die Abwägung.',
        fr: "Déterminez une base juridique valable (en général l'intérêt légitime) et documentez la mise en balance.",
        es: 'Identifique una base jurídica valida (por lo general el interés legítimo) y documente la ponderación.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        es: 'Realice la evaluación de impacto (EIPD) para el sistema de seguimiento.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Konfigurieren Sie das System verhältnismäßig: keine Ortung außerhalb der Arbeitszeit ohne Grundlage.',
        fr: 'Configurez le système de manière proportionnée: pas de suivi en dehors des heures de travail sans base.',
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: 'Eine spezifische und veröffentlichte Geldbusse der AZOP für GPS bei Arbeitnehmern ist nicht bekannt. Der starke Schutz liegt in der Regel des Art. 43 des Arbeitsschutzgesetzes: Eine Überwachung, die alle Bewegungen während der gesamten Arbeitszeit verfolgt, erfordert die vorherige Zustimmung des Betriebsrats. Das Sanktionsrisiko bleibt das allgemeine der DSGVO (Art. 83).',
      fr: "Aucune amende spécifique et publiée de l'AZOP pour le GPS sur les salaries n'est connue. La protection forte réside dans la règle de l'art. 43 de la loi sur la securite au travail: une surveillance qui suit tous les mouvements pendant toute la durée du travail requiert le consentement préalable du conseil des travailleurs. Le risque de sanction reste celui, général, du RGPD (art. 83).",
      es: 'No consta una multa especifica y publicada de la AZOP por el GPS sobre los empleados. La protección fuerte reside en la regla del art. 43 de la ley de seguridad en el trabajo: la vigilancia que sigue todos los movimientos durante toda la jornada requiere el consentimiento previo del consejo de trabajadores. El riesgo sancionador sigue siendo el general del RGPD (art. 83).',
