  ...
  checklist: [
    {
      ...
      dettaglio: {
        ...
        de: 'Der Arbeitgeber muss die Beschäftigten über Zwecke, Methoden, erhobene Daten und Rechte informieren und interne Regeln zur GPS-Verarbeitung samt einer vorherigen Bewertung der Sicherheitsmassnahmen erlassen.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Das geltende Gesetz sieht keine förmliche DSFA nach Vorbild der DSGVO vor; an ihre Stelle treten die vorherige Genehmigung nach Art. 27 sowie die Sicherheitsmassnahmen und die vorläufige Angemessenheitsbewertung (Art. 24 und 26).',
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        es: 'Informe por escrito a los trabajadores; para los vehículos privados, recoja el consentimiento escrito y límite el GPS al horario laboral.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        es: 'Límite el GPS al horario laboral y a la finalidad declarada.',
