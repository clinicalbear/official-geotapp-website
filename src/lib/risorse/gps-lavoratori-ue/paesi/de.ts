  ...
  checklist: [
    {
      ...
      dettaglio: {
        ...
        fr: "En Allemagne, la cogestion du Betriebsrat est obligatoire pour les systèmes techniques susceptibles de surveiller le comportement ou le rendement des travailleurs (article 87, al. 1, n° 6 BetrVG) : sans accord avec le comité d'entreprise, le système ne peut pas être activé. Mais cela ne s'appliqué QUE là où un Betriebsrat existe ; de nombreuses PME n'en ont pas, et alors cette étape n'existe pas (l'ensemble du RGPD reste applicable). Ce qui compte, c'est l'aptitude objective à surveiller, et non l'intention de l'employeur.",
    ...
    },
    {
      ...
      risposta: 'si',
      dettaglio: {
        it: "Serve una base giuridica. Attenzione: dopo la sentenza CGUE C-34/21 del 30 marzo 2023, il § 26 BDSG non basta da solo come base autonoma; il trattamento va fondato direttamente sull'art. 6 GDPR (es. esecuzione del contratto, obbligo legale, legittimo interesse con bilanciamento). Un'eventuale legge dedicata (Beschaeftigtendatengesetz) è in discussione ma NON risulta in vigore.",
