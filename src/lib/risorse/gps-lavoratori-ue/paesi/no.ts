  ...
  checklist: [
    ...
    },
    {
      ...
      dettaglio: {
        ...
        es: 'El capitulo 9 no prevé ninguna autorización previa del Datatilsynet; la licitud es responsabilidad del responsable del tratamiento.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        es: 'Antes de activarla, el empresario informa a los trabajadores sobre la finalidad de la medida, las consecuencias prácticas (como se llevara a cabo) y la duración prevista.',
    ...
    },
    {
      voce: {
        ...
        fr: 'GPS sur les véhicules uniquement pour la finalité declaree, sans réutilisation pour évaluer le rendement',
    ...
    },
    {
      voce: {
        ...
        fr: "Analyse d'impact relative a la protection des données pour la surveillance systématique des salaries et les données de localisation",
      ...
      dettaglio: {
        ...
        fr: "Le Datatilsynet exige toujours une analyse d'impact relative a la protection des données pour la surveillance systématique des salaries, et pour les données de localisation combinées a d'autres critères de risque.",
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        es: 'Informe a los trabajadores sobre la finalidad, las consecuencias y la duración antes de activar.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: "Réalisez l'analyse d'impact relative a la protection des données pour la surveillance systématique ou les données de localisation.",
        es: 'Realice la evaluación de impacto relativa a la protección de datos para la supervisión sistemática o los datos de localización.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: 'Configurez le système: finalité declaree uniquement, aucune réutilisation pour évaluer le rendement.',
        es: 'Configure el sistema: solo la finalidad declarada, sin reutilización para evaluar el rendimiento.',
