...
export const serbia: SchedaPaese = {
  ...
  checklist: [
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Grundlage ist das berechtigte Interesse des Arbeitgebers, das klar definiert, mit einer dreiteiligen Prüfung dokumentiert und dem Beschäftigten mitgeteilt werden muss; die Einwilligung im Arbeitsverhältnis ist die schwächste Grundlage.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Für den Poverenik ist die kontinuierliche GPS-Überwachung ein schwerwiegender Eingriff in die Privatsphäre, da sie eine Echtzeitverfolgung von Bewegungen und Verhalten ermöglicht; pauschale Rechtfertigungen mit dem Schutz von Vermögenswerten werden abgelehnt.',
    ...
    },
    {
      voce: {
        ...
        de: 'Folgenabschätzung (DSFA) und vorherige Stellungnahme des Poverenik für die Überwachung von Beschäftigten über Apps oder Ortungssysteme (Liste, LPDP Art. 54)',
      ...
      dettaglio: {
        ...
        de: 'Die Verarbeitung von Beschaeftigtendaten über Apps oder Systeme, die deren Arbeit, Bewegungen und Kommunikation verfolgen, steht auf der Liste, die eine Folgenabschätzung erfordert; für diese Verarbeitungen muss der Verantwortliche vor Beginn die DSFA durchführen und die Stellungnahme des Poverenik einholen.',
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Führen Sie die Folgenabschätzung (DSFA) durch und holen Sie vor Beginn die vorherige Stellungnahme des Poverenik ein.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        es: 'Límite el GPS al horario y a la finalidad: sin seguimiento continuo.',
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: 'Es gibt keine spezifische, veröffentlichte Geldbusse des Poverenik für GPS bei Beschäftigten. Im Jahr 2026 leitete der Poverenik eine außerordentliche Prüfung von JKP Mediana in Nis ein, das 80 GPS-Geräte an den Mülltonnen installiert hatte, was von den Reinigungskräften beanstandet wurde, weil dadurch indirekt ihre Bewegungen verfolgt wurden. Das Versäumnis, die DSFA durchzuführen oder die Stellungnahme einzuholen, wird mit einer Geldbusse von 50.000 bis 2.000.000 RSD für die juristische Person geahndet.',
