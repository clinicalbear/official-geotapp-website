...
export const portogallo: SchedaPaese = {
  ...
  checklist: [
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Mit der DSGVO ist die alte vorherige Genehmigung durch die CNPD weggefallen; es bleibt eine nachträgliche Kontrolle. Hinweis: Art. 21 CT wurde nicht ausdrücklich aufgehoben und die Lehre ist geteilt, in der Praxis wird die vorherige Genehmigung jedoch nicht mehr verlangt.',
        fr: 'Avec le RGPD, l\'ancienne autorisation préalable de la CNPD a disparu; un contrôle a posteriori subsiste. Note: l\'art. 21 CT n\'a pas été expressément abroge et la doctrine est divisée, mais en pratique l\'autorisation préalable n\'est plus exigée.',
        es: 'Con el RGPD ha desaparecido la antigua autorización previa de la CNPD; queda un control a posteriori. Nota: el art. 21 CT no ha sido expresamente derogado y la doctrina esta dividida, pero en la práctica ya no se exige la autorización previa.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Nach Auffassung der CNPD darf die Geolokalisierung den Arbeitnehmer weder orten noch seine Leistung überwachen, sie darf sich nicht auf Pausen und Ruhezeiten erstrecken, und der Arbeitnehmer muss außerhalb der Arbeitszeit in den Privatmodus wechseln können. Die Einwilligung des Arbeitnehmers ist keine gültige Rechtsgrundlage.',
        fr: 'Pour la CNPD, la géolocalisation ne peut localiser le travailleur ni surveiller son rendement, ne peut s\'étendre aux pauses et aux repos, et le travailleur doit pouvoir passer en mode prive en dehors des heures de travail. Le consentement du travailleur n\'est pas une base juridique valable.',
        es: 'Para la CNPD, la geolocalizacion no puede localizar al trabajador ni monitorizar su rendimiento, no puede extenderse a pausas y descansos, y el trabajador debe poder pasar al modo privado fuera del horario. El consentimiento del trabajador no es una base jurídica valida.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Die CNPD-Liste verlangt eine Folgenabschätzung für Verarbeitungen, die es ermöglichen, den Standort oder das Verhalten von Arbeitnehmern mit Bewertungs- oder Einstufungswirkung zu verfolgen.',
        fr: 'La liste de la CNPD exige une analyse d\'impact pour les traitements permettant de suivre la localisation ou les comportements des travailleurs avec un effet d\'évaluation ou de classification.',
        es: 'La lista de la CNPD exige una evaluación de impacto para los tratamientos que permiten rastrear la localización o los comportamientos de los trabajadores con efecto de evaluación o clasificación.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        fr: 'Lorsqu\'une commission des travailleurs existe, son avis doit être sollicite.',
        es: 'Cuando existe una comisión de trabajadores, debe solicitarse su dictamen.',
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        es: 'Si existe una comisión de trabajadores, solicite su dictamen.',
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      it: "Caso reale confermato in giudizio: il Tribunale da Relacao de Lisboa (2026) ha confermato la coima di 14.790 euro inflitta dall'ACT a un'azienda vinicola che aveva installato il GPS sull'auto di una venditrice e ne confrontava i tragitti con i rapporti giornalieri delle visite ai clienti. La CNPD non pubblica invece le singole decisioni sanzionatorie, quindi il tetto resta quello generale del GDPR (art. 83).",
      en: 'A real case confirmed in court: the Lisbon Court of Appeal (2026) upheld the EUR 14,790 fine imposed by the ACT on a wine company that had installed GPS in a saleswoman\'s car and compared her routes with the daily reports of customer visits. The CNPD, by contrast, does not publish individual sanction decisions, so the ceiling remains the general GDPR one (Article 83).',
      de: 'Ein realer, gerichtlich bestätigter Fall: das Berufungsgericht Lissabon (2026) bestätigte die vom ACT verhängte Geldbusse von 14.790 EUR gegen ein Weinunternehmen, das GPS im Auto einer Vertriebsmitarbeiterin installiert und ihre Fahrten mit den Tagesberichten der Kundenbesuche abgeglichen hatte. Die CNPD veröffentlicht dagegen keine einzelnen Sanktionsentscheidungen, sodass die Obergrenze die allgemeine der DSGVO bleibt (Art. 83).',
      fr: 'Un cas réel confirmé en justice: la Cour d\'appel de Lisbonne (2026) a confirmé l\'amende de 14 790 EUR infligée par l\'ACT a une entreprise vinicole qui avait installé un GPS dans la voiture d\'une commerciale et comparait ses trajets avec les rapports quotidiens de visites clients. La CNPD, en revanche, ne publie pas les décisions de sanction individuelles: le plafond reste donc celui, général, du RGPD (art. 83).',
      es: 'Un caso real confirmado en los tribunales: la Audiencia de Lisboa (2026) confirmo la multa de 14.790 EUR impuesta por la ACT a una empresa vinícola que había instalado un GPS en el coche de una comercial y comparaba sus recorridos con los partes diarios de visitas a clientes. La CNPD, en cambio, no publica las resoluciones sancionadoras individuales, por lo que el techo sigue siendo el general del RGPD (art. 83).',
