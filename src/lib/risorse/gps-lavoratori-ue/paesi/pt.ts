...
export const portogallo: SchedaPaese = {
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: 'Ein realer, gerichtlich bestaetigter Fall: das Berufungsgericht Lissabon (2026) bestaetigte die vom ACT verhaengte Geldbusse von 14.790 EUR gegen ein Weinunternehmen, das GPS im Auto einer Vertriebsmitarbeiterin installiert und ihre Fahrten mit den Tagesberichten der Kundenbesuche abgeglichen hatte. Die CNPD veroeffentlicht dagegen keine einzelnen Sanktionsentscheidungen, sodass die Obergrenze die allgemeine der DSGVO bleibt (Art. 83).',
      fr: 'Un cas reel confirme en justice: la Cour d\'appel de Lisbonne (2026) a confirme l\'amende de 14 790 EUR infligee par l\'ACT a une entreprise vinicole qui avait installe un GPS dans la voiture d\'une commerciale et comparait ses trajets avec les rapports quotidiens de visites clients. La CNPD, en revanche, ne publie pas les decisions de sanction individuelles: le plafond reste donc celui, general, du RGPD (art. 83).',
      es: 'Un caso real confirmado en los tribunales: la Audiencia de Lisboa (2026) confirmo la multa de 14.790 EUR impuesta por la ACT a una empresa vinicola que habia instalado un GPS en el coche de una comercial y comparaba sus recorridos con los partes diarios de visitas a clientes. La CNPD, en cambio, no publica las resoluciones sancionadoras individuales, por lo que el techo sigue siendo el general del RGPD (art. 83).',
