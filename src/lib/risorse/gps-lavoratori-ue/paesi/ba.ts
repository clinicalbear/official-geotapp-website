...
export const bosnia: SchedaPaese = {
  ...
  autoritaCompetente: {
    ...
    note: {
      ...
      fr: "La Bosnie-Herzegovine est un pays candidat, hors de l'UE ; depuis 2025, elle dispose d'une nouvelle loi alignée sur le RGPD. Une seule autorité nationale, l'AZLP ; aucune répartition par entité.",
  ...
  checklist: [
    ...
    },
    {
      ...
      dettaglio: {
        ...
        fr: "La nouvelle loi remplace l'obligation generale d'enregistrement auprès de l'Agence par la tenue d'un registre interne des traitements.",
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: 'Configurez le système de manière proportionnée a la finalité declaree.',
