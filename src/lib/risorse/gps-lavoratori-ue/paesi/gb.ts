  ...
  checklist: [
    ...
    },
    {
      ...
      dettaglio: {
        ...
        fr: "Aucune autorisation préalable de l'ICO n'est requise ; le principe de responsabilité s'appliqué (auto-évaluation + DPIA). L'ICO ne doit être consulté au préalable que si la DPIA met en évidence un risque élevé impossible à atténuer.",
    ...
    },
    {
      ...
      dettaglio: {
        ...
        es: 'El consentimiento por lo general no es válido debido al desequilibrio de poder; la base habitual es el interés legítimo con una evaluación documentada (LÍA). Los trabajadores deben ser informados con claridad; la vigilancia encubierta solo en casos excepcionales.',
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        es: 'Determina una base jurídica válida (por lo general el interés legítimo) y realiza la evaluación documentada (LÍA).',
