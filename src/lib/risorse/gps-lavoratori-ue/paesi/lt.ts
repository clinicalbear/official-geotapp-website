  ...
  checklist: [
    ...
    },
    {
      ...
      dettaglio: {
        ...
        fr: "Avec le RGPD, aucune notification ou autorisation préalable n est plus nécessaire; le responsable du traitement procède a une auto-évaluation et conserve la documentation.",
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Die Überwachung ist nur für einen tatsächlichen und gerechtfertigten Zweck zulässig; die Grundlage ist das berechtigte Interesse, nicht die Einwilligung, die im Arbeitsverhältnis nicht freiwillig erteilt wird.',
        fr: "La surveillance n est admise que pour une finalité réelle et justifiée; la base est l intérêt légitime, et non le consentement, qui dans la relation de travail n est pas librement donne.",
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Die Fahrzeugverfolgung muss außerhalb der Arbeitszeit ausgesetzt werden oder der Arbeitnehmer muss sie abschalten können; die kontinuierliche GPS-Verfolgung wurde als unverhältnismäßig angesehen, und ein weniger eingreifendes Mittel ist vorzuziehen.',
        fr: "Le suivi du véhicule doit être suspendu en dehors des heures de travail ou le travailleur doit pouvoir le désactiver; le suivi GPS continu a été jugé disproportionné et un moyen moins intrusif est a privilégier.",
    ...
    },
    {
      voce: {
        ...
        fr: "Analyse d impact relative a la protection des données (AIPD) pour la surveillance des salaries, y compris la position et le mouvement (liste VDAI, point 10)",
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: "Réalisez l analyse d impact relative a la protection des données (AIPD) pour la surveillance des salaries, y compris la position et le mouvement.",
