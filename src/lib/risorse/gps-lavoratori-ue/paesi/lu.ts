...
export const lussemburgo: SchedaPaese = {
  ...
  checklist: [
    {
      voce: {
        ...
        fr: 'Information collective préalable a la delegation du personnel et codécision (Code du travail art. L.261-1)',
        es: 'Información colectiva previa a la delegación del personal y codecision (Code du travail art. L.261-1)',
      ...
      dettaglio: {
        ...
        de: 'Vor der Installation der Überwachung muss der Arbeitgeber die Personaldelegation vorab informieren; für die vorgesehenen Zwecke unterliegt die Einführung der Mitentscheidung mit der Delegation. Dies gilt, wo eine Personaldelegation besteht.',
        fr: "Avant d'installer la surveillance, l'employeur doit informer préalablement la delegation du personnel; pour les finalités prévues, la mise en oeuvre est soumise a codécision avec la delegation. Cela vaut la ou une delegation du personnel existe.",
        es: 'Antes de instalar la supervisión, el empleador debe informar previamente a la delegación del personal; para las finalidades previstas, la puesta en marcha esta sujeta a codecision con la delegación. Se aplica donde existe una delegación del personal.',
    ...
    },
    {
      voce: {
        ...
        fr: "Possibilité pour la delegation ou les travailleurs de demander un avis préalable a la CNPD dans un délai de 15 jours (effet suspensif)",
      ...
      dettaglio: {
        ...
        de: 'Die Personaldelegation oder, falls keine besteht, die betroffenen Arbeitnehmer können innerhalb von 15 Tagen nach der vorherigen Information eine Stellungnahme der CNPD anfordern, und der Antrag hat aufschiebende Wirkung.',
        fr: "La delegation du personnel, ou a défaut les travailleurs concernés, peuvent demander dans les 15 jours suivant l'information préalable un avis a la CNPD, et la demande a un effet suspensif.",
        es: 'La delegación del personal, o en su ausencia los trabajadores afectados, pueden solicitar a la CNPD un dictamen en un plazo de 15 días desde la información previa, y la solicitud tiene efecto suspensivo.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Die frühere vorherige Genehmigung der CNPD wurde mit der DSGVO abgeschafft und durch die Mitentscheidung mit der Personaldelegation ersetzt; die Pflicht, das Verzeichnis der Verarbeitungstätigkeiten zu führen, bleibt bestehen.',
        fr: "L'ancienne autorisation préalable de la CNPD a été abolie avec le RGPD et remplacée par la codécision avec la delegation du personnel; l'obligation de tenir le registre des traitements subsiste.",
        es: 'La antigua autorización previa de la CNPD fue abolida con el RGPD y sustituida por la codecision con la delegación del personal; se mantiene la obligación de llevar el registro de las actividades de tratamiento.',
    ...
    },
    {
      voce: {
        ...
        fr: "Analyse d'impact (AIPD) pour la géolocalisation qui contrôle régulièrement ou systématiquement les salaries (par exemple pour le temps de travail)",
      ...
      dettaglio: {
        ...
        de: 'Eine Folgenabschätzung ist erforderlich, wenn die Ortung eine regelmäßige und systematische Überwachung der Beschäftigten mit sich bringt oder deren Arbeitszeit verfolgt.',
        fr: "Une analyse d'impact est nécessaire lorsque la géolocalisation entraine un contrôle régulier et systématique des salaries ou suit leur temps de travail.",
        es: 'Se requiere una evaluación de impacto cuando la geolocalizacion implica un control regular y sistemático de los empleados o sigue su tiempo de trabajo.',
  ...
  procedura: [
    {
      ...
      descrizione: {
        ...
        fr: 'Informez préalablement la delegation du personnel et activez la codécision (art. L.261-1).',
        es: 'Informe previamente a la delegación del personal y active la codecision (art. L.261-1).',
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: "Laissez a la delegation ou aux travailleurs la possibilité de demander un avis a la CNPD dans un délai de 15 jours (effet suspensif).",
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: "Réalisez l'analyse d'impact (AIPD) si la géolocalisation contrôle régulièrement les salaries.",
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: 'CNPD, Beschluss 11FR/2021 vom 8. April 2021: Sanktion gegen ein Unternehmen wegen eines rechtswidrig betriebenen Ortungssystems für Dienstfahrzeuge, mit übermäßiger Datenspeicherung (2 Jahre und 4 Monate), mangelhafter Information der Arbeitnehmer (Art. 13) und unzureichender Sicherheit (Art. 32). Geldbusse von 2.800 Euro.',
      fr: "CNPD, deliberation 11FR/2021 du 8 avril 2021: sanction a l'encontre d'une société pour un système de géolocalisation des véhicules de service exploite de manière illicite, avec une conservation des données excessive (2 ans et 4 mois), une information insuffisante des travailleurs (art. 13) et une securite insuffisante (art. 32). Amende de 2 800 euros.",
      es: 'CNPD, resolución 11FR/2021 de 8 de abril de 2021: sanción a una empresa por un sistema de geolocalizacion de vehículos de servicio gestionado de forma ilícita, con una conservación de datos excesiva (2 anos y 4 meses), información deficiente a los trabajadores (art. 13) y seguridad insuficiente (art. 32). Multa de 2.800 euros.',
