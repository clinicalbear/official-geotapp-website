...
export const spagna: SchedaPaese = {
  ...
  autoritaCompetente: {
    ...
    note: {
      ...
      es: "Para las empresas privadas la autoridad competente es siempre la AEPD nacional. Algunas comunidades autónomas (Cataluña APDCAT, País Vasco AVPD) tienen su propia autoridad, pero afecta sobre todo al sector publico de la región.",
  ...
  checklist: [
    {
      voce: {
        ...
        de: 'Ausdrückliche, klare und eindeutige Information der Beschäftigten vor der Aktivierung (LOPDGDD Art. 90)',
        fr: 'Information expresse, claire et sans ambiguïté des salaries avant l activation (LOPDGDD art. 90)',
        es: 'Información expresa, clara e inequívoca a los trabajadores antes de activar (LOPDGDD art. 90)',
      ...
      dettaglio: {
        ...
        de: "Art. 90 LOPDGDD gestattet die Verarbeitung von Standortdaten für die Kontrollbefugnisse nach Art. 20.3 des Arbeitnehmerstatuts, jedoch nur, nachdem die Beschäftigten (und, sofern vorhanden, ihre Vertreter) ausdrücklich, klar und eindeutig über das Bestehen und die Merkmale der Geräte sowie über ihre Rechte informiert wurden.",
        fr: "L'art. 90 LOPDGDD permet de traiter les données de géolocalisation pour les pouvoirs de contrôle de l'art. 20.3 du Statut des travailleurs, mais seulement après avoir informé de manière expresse, claire et sans ambiguïté les salaries (et, le cas échéant, leurs représentants) de l'existence et des caractéristiques des dispositifs ainsi que de leurs droits.",
        es: "El art. 90 LOPDGDD permite tratar los datos de geolocalizacion para las funciones de control del art. 20.3 del Estatuto de los Trabajadores, pero solo después de haber informado de forma expresa, clara e inequívoca a los trabajadores (y, si existen, a sus representantes) sobre la existencia y las características de los dispositivos y sobre sus derechos.",
    ...
    },
    {
      voce: {
        ...
        fr: 'Information des représentants des salaries (Estatuto art. 64)',
        es: 'Información a los representantes de los trabajadores (Estatuto art. 64)',
      ...
      dettaglio: {
        ...
        de: "Art. 64 des Statuts gibt dem Betriebsrat das Recht, informiert zu werden und einen vorherigen Bericht über die Einführung von Systemen zur Arbeitsorganisation und -kontrolle abzugeben. Dies gilt nur dort, wo Arbeitnehmervertreter vorhanden sind.",
        fr: "L'art. 64 du Statut donne au comite d'entreprise le droit d'être informe et d'émettre un rapport préalable sur l'introduction de systèmes d'organisation et de contrôle du travail. Cela s'appliqué uniquement la ou existent des représentants des salaries.",
        es: "El art. 64 del Estatuto otorga al comité de empresa el derecho a ser informado y a emitir un informe previo sobre la introducción de sistemas de organización y control del trabajo. Solo rige donde existen representantes de los trabajadores.",
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: "Spanien verlangt für die Installation eines Standortsystems keine behördliche oder arbeitsbehoerdliche Genehmigung. Die Schutzvorkehrungen sind die Information nach Art. 90 LOPDGDD, die Information der Vertreter (Art. 64) und die DSGVO.",
        fr: "L'Espagne ne prévoit pas d'autorisation administrative ni d'une autorité du travail pour installer un système de géolocalisation. Les garanties sont l'information au titre de l'art. 90 LOPDGDD, l'information des représentants (art. 64) et le RGPD.",
        es: "España no exige una autorización administrativa ni de una autoridad laboral para instalar un sistema de geolocalizacion. Las garantías son la información conforme al art. 90 LOPDGDD, la información a los representantes (art. 64) y el RGPD.",
    ...
    },
    {
      voce: {
        ...
        de: 'Verbot der ständigen Überwachung: Datenminimierung und Verhältnismäßigkeit',
        fr: 'Interdiction de la surveillance continue : minimisation et proportionnalité',
        es: 'Prohibición de la vigilancia continua: minimización y proporcionalidad',
      ...
      dettaglio: {
        ...
        de: "Die AEPD verlangt, dass die Standortbestimmung verhältnismäßig ist und nicht zur ständigen Überwachung genutzt wird; ist der Zweck die Arbeitszeiterfassung, dürfen die Daten nur Beginn und Ende der Tätigkeit angeben, nicht die Position in jedem Augenblick, und das System darf nach Arbeitsende nicht in Betrieb sein.",
        fr: "L'AEPD exige que la géolocalisation soit proportionnée et non utilisée pour une surveillance permanente ; si la finalité est l'enregistrement du temps de travail, les données ne peuvent indiquer que le début et la fin de l'activité, non la position a chaque instant, et le système ne doit pas être opérationnel une fois la journée terminée.",
        es: "La AEPD exige que la geolocalizacion sea proporcionada y no se use para una vigilancia permanente; si la finalidad es el registro horario, los datos solo pueden indicar el inicio y el fin de la actividad, no la posición en todo momento, y el sistema no debe estar operativo una vez finalizada la jornada.",
    ...
    },
    {
      voce: {
        ...
        de: 'Datenschutz-Folgenabschätzung (DSFA) bei systematischer und umfassender Standortbestimmung',
        fr: "Analyse d'impact (AIPD) pour une géolocalisation systématique et exhaustive",
        es: "Evaluación de impacto (EIPD) para geolocalizacion sistemática y exhaustiva",
      ...
      dettaglio: {
        ...
        de: "Die AEPD-Liste zählt zu den Verarbeitungen, die eine Folgenabschätzung erfordern, jene, die eine Beobachtung, Überwachung, Standortbestimmung oder Kontrolle der betroffenen Person in systematischer und umfassender Weise mit sich bringen.",
        fr: "La liste de l'AEPD inclut, parmi les traitements requérant une analyse d'impact, ceux qui impliquent l'observation, le suivi, la géolocalisation ou le contrôle de la personne concernée de manière systématique et exhaustive.",
        es: "La lista de la AEPD incluye, entre los tratamientos que requieren una evaluación de impacto, los que conllevan la observación, el seguimiento, la geolocalizacion o el control del interesado de forma sistemática y exhaustiva.",
    ...
    },
    {
      voce: {
        ...
        de: 'Gültige Rechtsgrundlage (Art. 20.3 Statut / Vertragserfüllung, DSGVO Art. 6)',
        fr: "Base juridique valable (art. 20.3 Statut / exécution du contrat, RGPD art. 6)",
        es: 'Base jurídica valida (art. 20.3 Estatuto / ejecución del contrato, RGPD art. 6)',
      ...
      dettaglio: {
        ...
        es: "El tratamiento se fundamenta en el poder de control del empleador (art. 20.3 Estatuto) y en la ejecución de la relación laboral, dentro de los limites del RGPD; no se admite una finalidad mas amplia que permita la observación continua de los trabajadores.",
  ...
  procedura: [
    {
      ...
      descrizione: {
        ...
        de: 'Informieren Sie die Beschäftigten vor der Aktivierung ausdrücklich, klar und eindeutig (Art. 90 LOPDGDD).',
        fr: "Informez les salaries de manière expresse, claire et sans ambiguïté avant l'activation (art. 90 LOPDGDD).",
        es: 'Informa a los trabajadores de forma expresa, clara e inequívoca antes de activar (art. 90 LOPDGDD).',
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: "Si des représentants des salaries existent, informez-les et recueillez leur rapport préalable (art. 64 Statut).",
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Legen Sie eine gültige Rechtsgrundlage fest (Kontrollbefugnis Art. 20.3 Statut / Vertragserfüllung).',
        fr: "Définissez une base juridique valable (pouvoir de contrôle art. 20.3 Statut / exécution du contrat).",
        es: 'Define una base jurídica valida (poder de control art. 20.3 Estatuto / ejecución del contrato).',
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Führen Sie die Folgenabschätzung (DSFA) durch, wenn die Standortbestimmung systematisch und umfassend ist.',
        fr: "Réalisez l'analyse d'impact (AIPD) si la géolocalisation est systématique et exhaustive.",
        es: 'Realiza la evaluación de impacto (EIPD) si la geolocalizacion es sistemática y exhaustiva.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Konfigurieren Sie das System mit Datenminimierung: keine ständige Überwachung, Deaktivierung außerhalb der Arbeitszeit; falls eine Arbeitszeiterfassung erforderlich ist, nur Beginn und Ende.',
        fr: "Configurez le système avec minimisation : pas de surveillance continue, désactivation en dehors des horaires ; si l'enregistrement du temps de travail est nécessaire, uniquement le début et la fin.",
        es: 'Configura el sistema con minimización: sin vigilancia continua, desactivación fuera del horario; si se necesita el registro horario, solo inicio y fin.',
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: "AEPD gegen Ares Capital S.A. (PS/00454/2024), 4. März 2026: Das Unternehmen verpflichtete die Fahrer, auf ihrem privaten Telefon Apps zu installieren, die fortlaufend Standortdaten erhoben (sowie Fotos und Audio/Video). Verstoß gegen die Datenminimierung (Art. 5.1.c), gegen die Rechtsgrundlage (Art. 6.1, keine freiwillige Einwilligung) und gegen die Informationspflicht (Art. 13 DSGVO).",
      fr: "AEPD contre Ares Capital S.A. (PS/00454/2024), 4 mars 2026 : la société obligeait les chauffeurs a installer sur leur téléphone personnel des applications qui collectaient en continu la géolocalisation (ainsi que des photos et de l'audio/vidéo). Violation de la minimisation (art. 5.1.c), de la base juridique (art. 6.1, consentement non libre) et de l'information (art. 13 RGPD).",
      es: "AEPD contra Ares Capital S.A. (PS/00454/2024), 4 de marzo de 2026: la sociedad obligaba a los conductores a instalar en su teléfono personal apps que recogían de forma continua la geolocalizacion (ademas de fotos y audio/video). Vulneración de la minimización (art. 5.1.c), de la base jurídica (art. 6.1, consentimiento no libre) y de la información (art. 13 RGPD).",
