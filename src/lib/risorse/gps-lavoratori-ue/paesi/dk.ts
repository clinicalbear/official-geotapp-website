...
export const danimarca: SchedaPaese = {
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: "In Dänemark verhängt nicht die Aufsichtsbehörde die DSGVO-Bußgelder: das Datatilsynet meldet den Fall der Polizei, das Gericht setzt die Geldbusse fest. Bei den Prüfungen 2020 zu GPS und Videoüberwachung von Beschäftigten ohne Datenschutzinformation sprach das Datatilsynet in drei von fünf Fällen 'ernste Kritik' (alvorlig kritik) aus, ohne Geldbussen. Achtung 2026: Kontrolle und Überwachung von Beschäftigten, einschließlich GPS in Firmenfahrzeugen, gehört zu den geplanten Pruefungsschwerpunkten des Jahres, mit Blick auf Zweckbindung, Verhältnismäßigkeit und Transparenz.",
      fr: "Au Danemark, ce n'est pas l'autorité de contrôle qui inflige les amendes RGPD: le Datatilsynet signale l'affaire a la police et le tribunal fixe le montant. Lors des contrôles de 2020 sur le GPS et la vidéosurveillance des salaries sans information préalable, le Datatilsynet a exprime une 'critique sérieuse' (alvorlig kritik) dans trois cas sur cinq, sans amende. A noter pour 2026: le contrôle et la surveillance des salaries, GPS des véhicules de société compris, figurent parmi les thèmes de contrôle programmes de l'année, avec une attention portée a la finalité, a la proportionnalité et a la transparence.",
      es: "En Dinamarca las multas del RGPD no las impone la autoridad de control: el Datatilsynet traslada el caso a la policía y el tribunal fija el importe. En las inspecciones de 2020 sobre GPS y videovigilancia de los empleados sin información previa, el Datatilsynet expreso 'crítica sería' (alvorlig kritik) en tres de los cinco casos, sin multas económicas. Ojo con 2026: el control y la vigilancia de los empleados, incluido el GPS en los vehículos de empresa, esta entre los temas de inspección programados del ano, con atención a la finalidad, la proporcionalidad y la transparencia.",
