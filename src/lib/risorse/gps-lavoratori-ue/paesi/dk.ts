...
export const danimarca: SchedaPaese = {
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      es: "En Dinamarca las multas del RGPD no las impone la autoridad de control: el Datatilsynet traslada el caso a la policia y el tribunal fija el importe. En las inspecciones de 2020 sobre GPS y videovigilancia de los empleados sin informacion previa, el Datatilsynet expreso 'critica seria' (alvorlig kritik) en tres de los cinco casos, sin multas economicas. Ojo con 2026: el control y la vigilancia de los empleados, incluido el GPS en los vehiculos de empresa, esta entre los temas de inspeccion programados del ano, con atencion a la finalidad, la proporcionalidad y la transparencia.",
