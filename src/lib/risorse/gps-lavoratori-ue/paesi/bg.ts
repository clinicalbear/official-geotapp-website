...
export const bulgaria: SchedaPaese = {
  ...
  checklist: [
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Für die systematische Überwachung öffentlich zugänglicher Bereiche in großem Umfang, einschließlich Videoüberwachung, sind Sonderregeln zu Rechtsgrundlagen, Zwecken, Umfang, Speicherung und Information erforderlich.',
        fr: 'Pour la surveillance systématique a grande échelle de zones accessibles au public, y compris la vidéosurveillance, des règles spéciales sont requises concernant les bases juridiques, les finalités, la portée, la conservation et l\'information.',
    ...
    },
    {
      voce: {
        ...
        fr: "Base = intérêt légitime (non le consentement, en raison du déséquilibre de pouvoir); proportionnalité; pas de suivi pendant l'usage prive du véhicule",
      ...
      dettaglio: {
        ...
        de: 'Nach Auffassung der CPDP kann die Einwilligung im Arbeitsverhältnis kaum freiwillig sein; die Grundlage ist das berechtigte Interesse, die Verarbeitung muss verhältnismäßig sein und der Arbeitgeber darf während der privaten Nutzung des Fahrzeugs keine Ortungsgeräte einsetzen.',
        fr: "Pour la CPDP, le consentement peut difficilement être libre dans la relation de travail; la base est l'intérêt légitime, le traitement doit être proportionné et l'employeur ne peut pas utiliser de dispositifs de suivi pendant l'usage prive du véhicule.",
        es: 'Para el CPDP, el consentimiento difícilmente es libre en la relación laboral; la base es el interés legítimo, el tratamiento debe ser proporcionado y el empleador no puede usar dispositivos de rastreo durante el uso privado del vehículo.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Die CPDP-Liste umfasst die Verarbeitung von Standortdaten zu Profiling-Zwecken mit erheblichen Auswirkungen; die systematische Überwachung von Beschäftigten gehört zu den Fällen mit hohem Risiko, die eine Folgenabschätzung erfordern.',
        fr: "La liste de la CPDP inclut le traitement des données de localisation a des fins de profilage avec des effets significatifs; la surveillance systématique des salaries figure parmi les cas a haut risque qui requièrent une analyse d'impact.",
        es: 'La lista del CPDP incluye el tratamiento de datos de localización con fines de elaboración de perfiles con efectos significativos; la vigilancia sistemática de los empleados se cuenta entre los casos de alto riesgo que requieren una evaluación de impacto.',
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: "Configurez le système: pas de suivi pendant l'usage prive du véhicule, uniquement pour les finalités déclarées.",
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: 'Es gibt keine spezifische, veröffentlichte Geldbusse der CPDP für GPS bei Beschäftigten. In einer Stellungnahme vom 24. November 2023 hielt die CPDP die Weiterverwendung von Videoueberwachungsaufzeichnungen zur Bewertung der Leistung von Beschäftigten von LUKOIL Bulgarien für unzulässig (unvereinbare Weiterverwendung, Art. 6 Abs. 4 DSGVO), ohne Geldbusse. Das Sanktionsrisiko bleibt das allgemeine der DSGVO (Art. 83).',
