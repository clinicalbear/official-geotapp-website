...
export const estonia: SchedaPaese = {
  ...
  autoritaCompetente: {
    ...
    note: {
      ...
      de: 'Estland hat eine einzige nationale Behörde, die AKI; keine regionale Aufteilung. Eine Besonderheit: DSGVO-Geldbussen laufen über das Ordnungswidrigkeitenverfahren; seit November 2023 ist die Obergrenze an die DSGVO angeglichen.',
  ...
  checklist: [
    {
      ...
      dettaglio: {
        ...
        de: 'Der Arbeitgeber muss den Beschäftigten erläutern, auf welcher Rechtsgrundlage das GPS installiert ist; im Arbeitsverhältnis ist die Einwilligung wegen des Machtungleichgewichts in der Regel keine gültige Grundlage.',
        fr: "L'employeur doit expliquer aux salaries sur quelle base juridique le GPS est installé; dans la relation de travail le consentement n'est generalement pas une base valable en raison du déséquilibre de pouvoir.",
        es: 'El empleador debe explicar a los trabajadores sobre que base jurídica se instala el GPS; en la relación laboral el consentimiento no suele ser una base valida por el desequilibrio de poder.',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Estland sieht keine verpflichtende Zustimmung eines Betriebsrats vor; die Prüfkriterien sind die DSGVO, die Leitlinien der AKI und der Grundsatz der Erforderlichkeit und Verhältnismäßigkeit.',
        fr: "L'Estonie ne prévoit pas de consentement obligatoire d'un comite d'entreprise; les filtres sont le RGPD, les lignes directrices de l'AKI et le principe de nécessite et de proportionnalité.",
        es: 'Estonia no prevé un consentimiento obligatorio de un comité de empresa; los filtros son el RGPD, las directrices de la AKI y el principio de necesidad y proporcionalidad.',
    ...
    },
    {
      voce: {
        ...
        de: 'Verhältnismäßiges GPS, nur während der Arbeitszeit, keine Echtzeitortung außerhalb der Arbeitszeit, abschaltbar',
        fr: 'GPS proportionné, uniquement pendant les heures de travail, pas de suivi en temps réel hors des heures de travail, désactivable',
      ...
      dettaglio: {
        ...
        de: 'Die Verarbeitung am Arbeitsplatz muss verhältnismäßig zu den Risiken sein; der Arbeitgeber darf die Beschäftigten außerhalb der Arbeitszeit nicht in Echtzeit verfolgen.',
        fr: "Le traitement sur le lieu de travail doit être proportionné aux risques; l'employeur ne peut pas suivre les salaries en temps réel en dehors des heures de travail.",
    ...
    },
    {
      ...
      dettaglio: {
        ...
        de: 'Die AKI-Liste führt die systematische Überwachung der Tätigkeiten der Beschäftigten in großem Umfang und die Echtzeitverfolgung des Standorts einer Person unter den Fällen auf, die eine Folgenabschätzung erfordern.',
        fr: "La liste de l'AKI inclut la surveillance systématique a grande échelle des activités des salaries et le suivi en temps réel de la position d'une personne parmi les cas qui exigent une analyse d'impact.",
        es: 'La lista de la AKI incluye la supervisión sistemática a gran escala de las actividades de los empleados y el seguimiento en tiempo real de la ubicación de una persona entre los casos que requieren una evaluación de impacto.',
  ...
  procedura: [
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Führen Sie die Datenschutz-Folgenabschätzung (DSFA) für die systematische Überwachung oder die Echtzeitverfolgung durch.',
        fr: "Réalisez l'analyse d'impact (AIPD) pour la surveillance systématique ou le suivi en temps réel.",
        es: 'Realice la evaluación de impacto (EIPD) para la supervisión sistemática o el seguimiento en tiempo real.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Konfigurieren Sie das System: nur während der Arbeitszeit, keine Echtzeitortung außerhalb der Arbeitszeit, abschaltbar.',
        fr: 'Configurez le système: uniquement pendant les heures de travail, pas de suivi en temps réel hors des heures de travail, désactivable.',
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: "Eine spezifische, veröffentlichte Geldbusse der AKI für GPS bei Beschäftigten ist nicht bekannt. In Estland laufen DSGVO-Geldbussen über das Ordnungswidrigkeitenverfahren und waren historisch niedrig; seit November 2023 ist die Obergrenze an die DSGVO angeglichen (bis zu 20 Millionen Euro oder 4% des Umsatzes). Die AKI achtet insbesondere auf Videoüberwachung und die Überwachung von Beschäftigten.",
      fr: "Aucune amende de l'AKI spécifique et publiée pour le GPS sur les salaries n'apparait. En Estonie les amendes RGPD passent par la procédure pour contraventions et ont historiquement été faibles; depuis novembre 2023 le plafond est aligne sur le RGPD (jusqu'à 20 millions d'euros ou 4% du chiffre d'affaires). L'AKI veille en particulier sur la vidéosurveillance et la surveillance des salaries.",
      es: "No consta una multa de la AKI especifica y publicada para el GPS sobre los empleados. En Estonia las multas del RGPD pasan por el procedimiento de faltas y históricamente han sido bajas; desde noviembre de 2023 el límite esta alineado con el RGPD (hasta 20 millones de euros o el 4% de la facturación). La AKI vigila en particular la videovigilancia y la supervisión de los empleados.",
