...
export const svezia: SchedaPaese = {
  ...
  autoritaCompetente: {
    ...
    note: {
      ...
      de: 'Schweden hat eine einzige nationale Behörde, die IMY (früher Datainspektionen); es gibt keine regionale Aufteilung.',
      fr: "La Suède dispose d'une seule autorité nationale, l'IMY (anciennement Datainspektionen); il n'existe aucune répartition régionale.",
      es: 'Suecia tiene una única autoridad nacional, la IMY (antes Datainspektionen); no existe ninguna división regional.',
  ...
  checklist: [
    {
      voce: {
        ...
        de: 'Vorherige Gewerkschaftsverhandlung (MBL § 11) vor Einführung des Systems',
        fr: "Négociation syndicale préalable (MBL art. 11) avant d'introduire le système",
        es: 'Negociación sindical previa (MBL art. 11) antes de introducir el sistema',
    ...
    },
    {
      ...
      dettaglio: {
        ...
        es: 'No existe un régimen de autorización previa de la IMY para el GPS sobre los empleados; rige la responsabilidad proactiva (el empleador documenta por si mismo la base jurídica y la ponderación de intereses).',
    ...
    },
    {
      voce: {
        ...
        de: 'Grundlage = Interessenabwägung (nicht Einwilligung) + klare Information der Beschäftigten',
        fr: "Base = mise en balance des intérêts (pas le consentement) + information claire des salaries",
        es: 'Base = ponderación de intereses (no el consentimiento) + información clara a los trabajadores',
    ...
    },
    {
      voce: {
        ...
        de: 'GPS nur für einen konkreten betrieblichen Bedarf; keine ungerechtfertigte Echtzeitüberwachung, keine Weiterverwendung zur Leistungsbewertung',
        fr: "GPS uniquement pour un besoin opérationnel concret; pas de surveillance en temps réel injustifiée, pas de réutilisation pour évaluer le rendement",
        es: 'GPS solo para una necesidad operativa concreta; sin vigilancia en tiempo real injustificada, sin reutilización para evaluar el rendimiento',
      ...
      dettaglio: {
        ...
        es: 'La localización se admite si esta justificada por una necesidad concreta de la empresa; no para vigilar en tiempo real sin motivo, y los datos recogidos para otra finalidad (p. ej. un registro de conducción) no pueden reutilizarse para analizar el rendimiento.',
    ...
    },
    {
      voce: {
        ...
        de: 'Datenschutz-Folgenabschätzung bei systematischer Überwachung der Beschäftigten',
        fr: "Analyse d'impact en cas de surveillance systématique des salaries",
        es: 'Evaluación de impacto para el control sistemático de los empleados',
      ...
      dettaglio: {
        ...
        es: 'Es necesaria una evaluación de impacto cuando el tratamiento implica un control sistemático de los empleados y es probable un alto riesgo para sus derechos.',
  ...
  procedura: [
    {
      ...
      descrizione: {
        ...
        fr: "Si vous êtes lie par une convention collective, négociez avec le syndicat avant d'introduire le système (MBL art. 11).",
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Dokumentieren Sie die Rechtsgrundlage (Interessenabwägung) und den zugehörigen Test.',
        fr: 'Documentez la base juridique (mise en balance des intérêts) et le test correspondant.',
        es: 'Documente la base jurídica (ponderación de intereses) y la prueba correspondiente.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        de: 'Informieren Sie die Beschäftigten klar, spätestens bei der Erhebung der Daten.',
        fr: 'Informez clairement les salaries, au plus tard lors de la collecte des données.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        es: 'Realice la evaluación de impacto si el control es sistemático.',
    ...
    },
    {
      ...
      descrizione: {
        ...
        fr: "Configurez le système: uniquement un besoin opérationnel concret, pas de réutilisation pour évaluer le rendement.",
        es: 'Configure el sistema: solo una necesidad operativa concreta, sin reutilización para evaluar el rendimiento.',
  ...
  sanzioneMax: {
    ...
    casoCitato: {
      ...
      de: 'IMY gegen die Gemeinde Skelleftea (2019): Eine Schule nutzte kamerabasierte Gesichtserkennung, um die Anwesenheit der Schüler zu erfassen, eine unzulässige biometrische Verarbeitung (die Einwilligung ist im Abhangigkeitsverhaltnis nicht gültig). Es ist kein GPS-Fall, aber der wegweisende schwedische Fall zur biometrischen Anwesenheitserfassung.',
      fr: "IMY contre la commune de Skelleftea (2019): une école utilisait la reconnaissance faciale par caméra pour enregistrer la présence des élèves, un traitement biométrique illicite (le consentement n'est pas valable dans un lien de subordination). Ce n'est pas une affaire de GPS, mais c'est l'affaire phare suédoise sur le contrôle biométrique des présences.",
      es: 'IMY contra el Municipio de Skelleftea (2019): un centro escolar usaba el reconocimiento facial por cámara para registrar la asistencia de los alumnos, un tratamiento biometrico ilícito (el consentimiento no es valido en una relación de dependencia). No es un caso de GPS, pero es el caso de referencia sueco sobre el control biometrico de la asistencia.',
