...
export const SURVEY: Record<SurveyLocale, SurveyContent> = {
  it: {
    ...
    emailLabel: 'Lascia la mail e ti arrivano i risultati europei quando chiudiamo, con il fac-simile dell’informativa GPS già pronto (facoltativo)',
  ...
  en: {
    ...
    emailLabel: 'Leave your email and you get the European results when we close, plus the ready-made GPS privacy notice template (optional)',
  ...
  de: {
    ...
    emailLabel: 'E-Mail hinterlassen und du bekommst die europäischen Ergebnisse zum Abschluss, dazu die fertige Vorlage für den GPS-Datenschutzhinweis (optional)',
  ...
  nl: {
    ...
    emailLabel: 'Laat je e-mail achter en je krijgt de Europese resultaten bij afsluiting, plus het kant-en-klare model voor de GPS-privacyverklaring (optioneel)',
  ...
  fr: {
    ...
    emailLabel: 'Laisse ton e-mail et tu reçois les résultats européens à la clôture, avec le modèle d’information GPS prêt à l’emploi (facultatif)',
  ...
  es: {
    ...
    emailLabel: 'Deja tu correo y recibes los resultados europeos al cierre, junto al modelo de información GPS listo para usar (opcional)',
  ...
  pt: {
    ...
    emailLabel: 'Deixa o teu email e recebes os resultados europeus no fecho, com o modelo de informação GPS pronto a usar (opcional)',
  ...
  da: {
    ...
    emailLabel: 'Efterlad din e-mail, så får du de europæiske resultater når vi lukker, plus den færdige skabelon til GPS-oplysningen (valgfrit)',
  ...
  sv: {
    ...
    emailLabel: 'Lämna din e-post så får du de europeiska resultaten när vi stänger, plus den färdiga mallen för GPS-informationen (valfritt)',
  ...
  nb: {
    ...
    emailLabel: 'Legg igjen e-posten din, så får du de europeiske resultatene når vi lukker, pluss den ferdige malen for GPS-informasjonen (valgfritt)',
  ...
  ru: {
    ...
    emailLabel: 'Оставьте e-mail и получите европейские результаты по итогам опроса, вместе с готовым образцом уведомления о GPS (необязательно)',
