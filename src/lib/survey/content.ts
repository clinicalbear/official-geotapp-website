...
export const SURVEY: Record<SurveyLocale, SurveyContent> = {
  it: {
    ...
    emailLabel: 'Lascia la mail e ti mando i risultati europei quando chiudiamo, paese per paese. Non esistono altrove (facoltativo)',
  ...
  en: {
    ...
    emailLabel: 'Leave your email and I will send you the European results when we close, country by country. They exist nowhere else (optional)',
  ...
  de: {
    ...
    emailLabel: 'E-Mail hinterlassen und du bekommst zum Abschluss die europäischen Ergebnisse, Land für Land. Die gibt es sonst nirgends (optional)',
  ...
  nl: {
    ...
    emailLabel: 'Laat je e-mail achter en je krijgt bij afsluiting de Europese resultaten, land per land. Die bestaan nergens anders (optioneel)',
  ...
  fr: {
    ...
    emailLabel: 'Laisse ton e-mail et tu reçois les résultats européens à la clôture, pays par pays. Ils n’existent nulle part ailleurs (facultatif)',
  ...
  es: {
    ...
    emailLabel: 'Deja tu correo y recibes los resultados europeos al cierre, país por país. No existen en ningún otro sitio (opcional)',
  ...
  pt: {
    ...
    emailLabel: 'Deixa o teu email e recebes os resultados europeus no fecho, país a país. Não existem em mais lado nenhum (opcional)',
  ...
  ru: {
    ...
    emailLabel: 'Оставьте e-mail и получите европейские результаты по итогам опроса, по каждой стране. Больше их нигде нет (необязательно)',
