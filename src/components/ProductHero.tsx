  ...
  return (
    <section className="relative pt-5 pb-20 px-6 overflow-hidden">
      <div className="container mx-auto max-w-6xl relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div
            className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 ${color} mb-6`}
          >
            <Icon size={16} />
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href={primaryLink}
              className={`px-8 py-4 rounded-xl font-bold text-white bg-gradient-to-r ${gradient} hover:scale-105 transition-transform shadow-lg`}
            >
              Get Started
            </Link>
            {secondaryLink && (
              <Link
                href={secondaryLink}
                className="px-8 py-4 rounded-xl font-bold text-white bg-surface border border-border hover:bg-white/5 transition-colors flex items-center gap-2"
              >
        ...
        >
          <div
            className={`absolute inset-0 bg-gradient-to-tr ${gradient} rounded-full blur-[100px] opacity-20`}
          />
            ...
            <div className="space-y-4">
              <div className="h-32 bg-black/40 rounded-xl border border-white/5 p-4">
                ...
                <div className="space-y-2">
                  ...
                  <div
                    className={`h-2 w-5/6 bg-gradient-to-r ${gradient} opacity-50 rounded`}
                  />
                </div>
              </div>
