...
const FOOTER_LABELS: Record<string, {
  ...
  pt: { products: 'Produtos', solutions: 'Setores', resources: 'Recursos', company: 'Empresa', legal: 'Legal', flow: 'GeoTapp Flow', timetracker: 'TimeTracker', verifier: 'Verifier', pricing: 'Preços', bundle: 'Bundle', video: 'Vídeo', blog: 'Blog', guide: 'Guia do utilizador', roi: 'Calculadora ROI', demo: 'Demo', comparisons: 'Comparações', features: 'Funcionalidades', about: 'Sobre nós', press: 'Imprensa', whatis: 'O que é GeoTapp', contact: 'Contacto', trial: 'Teste gratuito', login: 'Entrar', privacy: 'Política de privacidade', terms: 'Termos', cookies: 'Política de cookies', accessibility: 'Acessibilidade', sectors: 'Todos os setores', cleaning: 'Limpeza', installers: 'Instaladores', security: 'Segurança' },
  nl: { products: 'Producten', solutions: 'Sectoren', resources: 'Bronnen', company: 'Bedrijf', legal: 'Juridisch', flow: 'GeoTapp Flow', timetracker: 'TimeTracker', verifier: 'Verifier', pricing: 'Prijzen', bundle: 'Bundle', video: 'Video', blog: 'Blog', guide: 'Gebruikershandleiding', roi: 'ROI-calculator', demo: 'Demo', comparisons: 'Vergelijkingen', features: 'Functies', about: 'Over ons', press: 'Pers', whatis: 'Wat is GeoTapp', contact: 'Contact', trial: 'Gratis proefperiode', login: 'Inloggen', privacy: 'Privacybeleid', terms: 'Voorwaarden', cookies: 'Cookiebeleid', accessibility: 'Toegankelijkheid', sectors: 'Alle sectoren', cleaning: 'Schoonmaak', installers: 'Installateurs', security: 'Beveiliging' },
  da: { products: 'Produkter', solutions: 'Sektorer', resources: 'Ressourcer', company: 'Virksomhed', legal: 'Juridisk', flow: 'GeoTapp Flow', timetracker: 'TimeTracker', verifier: 'Verifier', pricing: 'Priser', bundle: 'Bundle', video: 'Video', blog: 'Blog', guide: 'Brugervejledning', roi: 'ROI-beregner', demo: 'Demo', comparisons: 'Sammenligninger', features: 'Funktioner', about: 'Om os', press: 'Presse', whatis: 'Hvad er GeoTapp', contact: 'Kontakt', trial: 'Gratis prøveperiode', login: 'Log ind', privacy: 'Privatlivspolitik', terms: 'Vilkår', cookies: 'Cookiepolitik', accessibility: 'Tilgængelighed', sectors: 'Alle sektorer', cleaning: 'Rengøring', installers: 'Installatører', security: 'Sikkerhed' },
  sv: { products: 'Produkter', solutions: 'Sektorer', resources: 'Resurser', company: 'Företag', legal: 'Juridiskt', flow: 'GeoTapp Flow', timetracker: 'TimeTracker', verifier: 'Verifier', pricing: 'Priser', bundle: 'Bundle', video: 'Video', blog: 'Blog', guide: 'Användarguide', roi: 'ROI-kalkylator', demo: 'Demo', comparisons: 'Jämförelser', features: 'Funktioner', about: 'Om oss', press: 'Press', whatis: 'Vad är GeoTapp', contact: 'Kontakt', trial: 'Gratis provperiod', login: 'Logga in', privacy: 'Integritetspolicy', terms: 'Villkor', cookies: 'Cookiepolicy', accessibility: 'Tillgänglighet', sectors: 'Alla sektorer', cleaning: 'Städning', installers: 'Installatörer', security: 'Säkerhet' },
  nb: { products: 'Produkter', solutions: 'Sektorer', resources: 'Ressurser', company: 'Bedrift', legal: 'Juridisk', flow: 'GeoTapp Flow', timetracker: 'TimeTracker', verifier: 'Verifier', pricing: 'Priser', bundle: 'Bundle', video: 'Video', blog: 'Blog', guide: 'Brukerveiledning', roi: 'ROI-kalkulator', demo: 'Demo', comparisons: 'Sammenligninger', features: 'Funksjoner', about: 'Om oss', press: 'Presse', whatis: 'Hva er GeoTapp', contact: 'Kontakt', trial: 'Gratis prøveperiode', login: 'Logg inn', privacy: 'Personvern', terms: 'Vilkår', cookies: 'Informasjonskapsler', accessibility: 'Tilgjengelighet', sectors: 'Alle sektorer', cleaning: 'Rengjøring', installers: 'Installatører', security: 'Sikkerhet' },
  ru: { products: 'Продукты', solutions: 'Отрасли', resources: 'Ресурсы', company: 'Компания', legal: 'Правовая информация', flow: 'GeoTapp Flow', timetracker: 'TimeTracker', verifier: 'Verifier', pricing: 'Цены', bundle: 'Bundle', video: 'Видео', blog: 'Блог', guide: 'Руководство', roi: 'Калькулятор ROI', demo: 'Демо', comparisons: 'Сравнения', features: 'Возможности', about: 'О нас', press: 'Пресса', whatis: 'Что такое GeoTapp', contact: 'Контакты', trial: 'Бесплатная пробная версия', login: 'Войти', privacy: 'Политика конфиденциальности', terms: 'Условия', cookies: 'Политика cookies', accessibility: 'Доступность', sectors: 'Все отрасли', cleaning: 'Уборка', installers: 'Монтажники', security: 'Охрана' },
};

/** Coda della direzione L: nero pieno, marchio grande, colonne a filo. */
  ...
  return (
    <footer className="ft">
      <div className="w">
        ...
        <div className="news">
          <div>
            <p className="kk k">Newsletter</p>
            <h2>{dict.newsletter_title}</h2>
            <p>{dict.newsletter_desc}</p>
          </div>
          <div>
        ...
        <div className="g g5">
          <div>
            ...
            <img src="/LogoGeoTapp.webp" alt="GeoTapp" />
            <p>{dict.tagline}</p>
            <div className="soc" style={{ marginTop: 24 }}>
              <a href="https://t.me/geotapp" target="_blank" rel="noopener noreferrer nofollow" aria-label="Telegram">
              ...
              <a href={({ fr: 'https://www.instagram.com/geotapp_france/', de: 'https://www.instagram.com/geotapp_german/', en: 'https://www.instagram.com/geotapp_english/' } as Record<string, string>)[currentLocale] ?? 'https://www.instagram.com/geotapp_official/'} target="_blank" rel="noopener noreferrer nofollow" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@geotapp" target="_blank" rel="noopener noreferrer nofollow" aria-label="TikTok">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
              </a>
              <a href="https://www.youtube.com/@GeoTappOfficial" target="_blank" rel="noopener noreferrer nofollow" aria-label="YouTube">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              <a href="https://it.trustpilot.com/review/geotapp.com" target="_blank" rel="noopener noreferrer nofollow" aria-label="Trustpilot">
          ...
          <div>
            <h4>{t.products}</h4>
            <Link href={getLink('/products/geotapp-flow')}>{t.flow}</Link>
            <Link href={getLink('/products/geotapp-timetracker')}>{t.timetracker}</Link>
          ...
          <div>
            <h4>{t.solutions}</h4>
            <Link href={getLink('/settori')}>{t.sectors}</Link>
          ...
          <div>
            <h4>{t.company}</h4>
            <Link href={getLink('/chi-siamo')}>{t.about}</Link>
            <Link href={getLink('/stampa')}>{t.press}</Link>
            <Link href={getLink('/cos-e-geotapp')}>{t.whatis}</Link>
            <Link href={getLink('/contact')}>{t.contact}</Link>
            <Link href={getLink('/trial')} onClick={() => trackEvent('trial_click', { cta_source: 'footer', cta_locale: currentLocale })}>{t.trial}</Link>
            <Link href={getLink('/login')}>{t.login}</Link>
          </div>

          <div>
            <h4>{t.legal}</h4>
            <Link href={getLink('/privacy')}>{t.privacy}</Link>
            <Link href={getLink('/terms')}>{t.terms}</Link>
            <Link href={getLink('/cookies')}>{t.cookies}</Link>
