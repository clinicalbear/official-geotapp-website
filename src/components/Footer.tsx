        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href={({'fr':'https://www.facebook.com/profile.php?id=61589271531399','de':'https://www.facebook.com/profile.php?id=61560169964763','en':'https://www.facebook.com/profile.php?id=61588876148784'} as Record<string,string>)[currentLocale] ?? 'https://www.facebook.com/geotapp/'} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-text-secondary hover:text-text-primary transition-colors">
