    ...
    <div className="rounded-2xl border border-emerald-200 bg-white overflow-hidden shadow-sm">
      ...
      <div className="px-6 py-4 flex flex-col sm:flex-row gap-3 bg-slate-50/50">
        <a
          ...
          className="flex items-center justify-center gap-2 px-5 py-2.5 bg-emerald-700 text-white font-semibold rounded-xl text-sm hover:bg-emerald-600 transition-all hover:shadow-md"
        >
          <Download size={16} />
          {d.btn_download}
        </a>
        <Link
          ...
          className="flex items-center justify-center gap-2 px-5 py-2.5 text-emerald-700 font-semibold rounded-xl text-sm border border-emerald-200 hover:bg-emerald-50 transition-all"
        >
          <ShieldCheck size={16} />
          {d.btn_verify}
        </Link>
