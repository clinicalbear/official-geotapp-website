...
const content: SettoreContent = {
  ...
  scenario: {
    title: 'Real case',
    body: 'The client claims the guard was not at their post during a critical time window. With GeoTapp you open the shift report: verified GPS at the checkpoint, immutable timestamp, site photo — all automatically generated from the guard\'s smartphone during duty.',
    resolution: 'The dispute drops. The contract stays.',
  },

  features: {
    title: 'Security company software: certified shifts, documented patrols.',
    items: [
      {
