...
const content: SettoreContent = {
  ...
  pain: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'As rendições de vigilantes fazem-se verbalmente ou com notas manuscritas. Informações críticas perdem-se, responsabilidades ficam pouco claras e qualquer auditoria posterior torna-se inviável.',
      },
    ],
  },
  workflow: {
    ...
    steps: [
      ...
      {
        title: 'O registo de presença está pronto para o cliente',
        desc: 'No final do turno, o registo de presença está estruturado com dados GPS reais, pronto para auditoria do cliente ou inspeção do Serviço de Segurança Privada (SSP) da PSP.',
      },
    ],
  },
  features: {
    ...
    items: [
      {
        title: 'Presença GPS verificada por vigilante',
        desc: 'Cada registo está ligado à posição, timestamp e posto atribuído. Defensável perante o cliente, o SSP/PSP e em qualquer litígio contratual.',
      },
      {
      ...
      },
      {
        ...
        desc: 'Exporte as presenças mensais nos formatos aceites pelos principais softwares de processamento salarial em Portugal. O processamento de salários torna-se uma operação rápida e sem erros de transcrição.',
      },
    ],
  },
  testimonial: {
  ...
  faq: {
    ...
    subtitle: 'O que as equipas nos perguntam com mais frequência antes de começar.',
    items: [
      {
      ...
      },
      {
        ...
        a: 'Sim. As rendições são registadas digitalmente com confirmação, notas operacionais e estado dos postos. O responsável tem visibilidade completa da continuidade do serviço sem depender de comunicações verbais.',
      },
    ],
  },
  cta: {
