...
const content: SettoreContent = {
  ...
  pain: {
    title: 'Problemet som alle rørleggere kjenner',
    items: [
      {
        title: 'Kunden bestrider reparasjonen eller materialene',
        desc: 'De sier at reparasjonen ikke ble utført, eller at materialene var annerledes. Uten verifiserbart bevis blir enhver tvist ord mot ord.',
      },
      {
  ...
  features: {
    title: 'App for rørleggere: hva du får med GeoTapp.',
    items: [
      {
        title: 'Verifiserbar GPS-tidsregistrering',
        desc: 'Hvert ankomst og avgang registreres med lokasjon, tidsstempel og oppdrag.',
      },
      {
      ...
      },
      {
        ...
        desc: 'Timer, bilder, notater, materialer og underskrift klare ved avslutning.',
      },
      {
        title: 'Styring av akuttoppdrag og vedlikehold',
        desc: 'Akuttoppdrag og planlagt vedlikehold fra samme dashboard.',
      },
      {
        title: 'Lønnseksport',
        desc: 'Kompatibel med Visma, Tripletex og Uni Economy.',
      },
      {
        title: 'Dine rørleggere er beskyttet',
        desc: 'Verifiserbare bevis mot anklager om ikke utført arbeid.',
      },
    ],
  },
  testimonial: {
    quote: 'Før brukte jeg timer på å forklare arbeid til kunder. Nå sender jeg rapporten og diskusjonen stopper der.',
    author: 'Robert C.',
    role: 'Eier, rørlegger og varmeanlegg',
  },
  faq: {
    title: 'Vanlige spørsmål',
    subtitle: 'Hva rørleggere og VVS-installatører spør oss om før de starter.',
    items: [
      {
        q: 'Håndterer GeoTapp både akuttoppdrag og planlagt vedlikehold?',
        a: 'Ja. Begge typer arbeid styres fra samme app med komplett historikk, GPS-bilder og automatiske rapporter.',
      },
      {
  ...
  schema_sector_name: 'Rørleggere og VVS-installatører',
};
