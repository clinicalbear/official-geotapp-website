...
const content: SettoreContent = {
  ...
  workflow: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'At the end of the job the system generates a sealed report: GPS timestamp, system photos, materials used, technical notes. Tamper-proof. The client can verify it independently.',
      },
    ],
  },
  differenza: {
  ...
  prima_dopo: {
    ...
    dopo: [
      'Client disputes that the repair was completed.',
      'You open the report: GPS photos of the system, certified timestamp, technical notes.',
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'The engineer photographs before and after the job. Every image is linked to GPS and timestamp — tamper-proof after generation.',
      },
      {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Yes. The engineer photographs before and after the job. Every image is linked to GPS, timestamp and job reference — included in the tamper-proof report.',
      },
      {
  ...
  schema_faq: [
    ...
    {
      question: 'How do I certify a plumbing or heating job with GeoTapp?',
