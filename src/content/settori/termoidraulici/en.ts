  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Yes. The engineer photographs the old part removed and the new one fitted from the app. Every image is linked to GPS, timestamp and job reference, included in the sealed report.',
      },
      {
