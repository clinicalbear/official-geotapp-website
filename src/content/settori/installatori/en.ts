...
const content: SettoreContent = {
  ...
  differenza: {
    title: 'App for installers: time tracking or job certification?',
  ...
  prima_dopo: {
    ...
    dopo: [
      'The client disputes the time or the work completed.',
      'You open the report: photos, GPS, timestamp, digital signature.',
  ...
  scenario: {
    title: 'Real case',
    body: 'The client disputes the end time of a job and requests a discount on the invoice. With GeoTapp you open the job report: photo of the completed installation, verified GPS timestamp, duration calculated automatically, all generated from the technician\'s smartphone at the time of work.',
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'The technician photographs directly from the app. Every image is linked to the job with GPS and timestamp, included in the sealed report, tamper-proof after generation.',
      },
      {
      ...
      },
      {
        ...
        desc: 'Assign jobs, track progress across all sites and receive automatic alerts if a job is not opened or closed on time.',
      },
      {
        title: 'Automatic digital job sheets',
        desc: 'At the end of the job the report is ready: hours, photos, notes and signature. No paper, no calls. The engineer sends it to the client directly from the app.',
      },
      {
        title: 'Your engineers are protected',
        desc: 'A verifiable report protects the engineer from unfounded accusations. Good work is proven by the data. No grey areas between field and office.',
      },
    ],
  },
  ...
  cta_mid: {
    ...
    body: 'We show you the complete flow: from opening a job to the report the client receives. In 20 minutes you\'ll know if it\'s right for you, no commitment.',
    cta: 'Request a Demo',
  },

  trust: {
    title: 'Our reports cannot be altered. Not by you. Not by us.',
    body: 'GeoTapp reports are generated by the system at the moment of the job. There is no panel to "correct" a time or move a photo. The data is what it is, digitally signed, with real GPS. When you show it to a client or a lawyer, it holds up.',
