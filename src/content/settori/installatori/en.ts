  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'The technician photographs directly from the app. Every image is linked to the job with GPS and timestamp, included in the sealed report, tamper-evident after generation.',
      },
      {
