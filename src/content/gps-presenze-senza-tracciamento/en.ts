...
const en: PresenzeCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'In the attendance log, coordinates are deleted after twelve months; a company can shorten that window down to thirty days. In reports already delivered to a client, location data remains: those are sealed documents that serve as proof of work performed, and they follow the retention period that applies to that kind of documentation, not the log\'s.',
  ...
  table: {
    ...
    left: [
      ...
      'One GPS point per work-proof photo, taken live',
      'A timestamp generated by the server, not by the worker\'s device',
    ],
    right: [
      ...
      'No location from photos uploaded from a gallery: live camera only',
    ],
  },
    ...
    items: [
      {
        ...
        a: 'No. Data protection authorities have never banned GPS on workers as such. What they fine is continuous tracking, missing information notices, and collecting data that has nothing to do with work: not point-in-time location capture at clock-in.',
      },
      {
        q: 'Do you always need a works-council agreement to use GPS for attendance?',
        a: 'You need one where the system could enable remote monitoring of an employee\'s activity. The Court of Cosenza ruled, though, that a system capturing location only at clock-in, with no continuous tracking, falls under attendance-recording tools that do not require that procedure.',
      },
      {
      ...
      },
      {
        ...
        a: 'No. In the attendance log it is deleted after twelve months, and a company can shorten that to thirty days. It remains in reports already delivered to a client, because those are sealed documents that serve as proof of work performed.',
      },
    ],
  },
