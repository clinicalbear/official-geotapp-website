...
const nl: VerifierCopy = {
  ...
  download_desc: 'Controleer offline de integriteit van GeoTapp-rapporten. Geen account nodig: via terminal of Node.js-bibliotheek voor ontwikkelaars, of één HTML-bestand dat met een dubbelklik opent voor iedereen anders.',
  download_btn_cli: 'Downloaden voor de terminal (Node.js)',
  download_btn_html: 'Download de lokale HTML-versie',
  download_version: 'v0.3.0 · dezelfde verificatie-engine, twee formaten',
