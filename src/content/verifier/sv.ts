...
const sv: VerifierCopy = {
  ...
  how_steps: [
    ...
    },
    {
      ...
      desc: 'Vem som helst kan verifiera rapporten med GeoTapp Verifier. Systemet jämför dokumentet med de registrerade operativa data och förseglar om rapporten är intakt och autentisk.',
    },
  ],
  ...
  ecosystem_desc:
    'GeoTapp Verifier är inte ett fristående verktyg. Det är det sista steget i en integrerad operativ cykel: data samlas in i fält med TimeTracker, organiseras i Flow och förseglas sedan av Verifier.',
  ...
  download_desc: 'Verifiera GeoTapp-rapporters integritet offline. Inget konto krävs: via terminal eller Node.js-bibliotek för utvecklare, eller en enda HTML-fil som öppnas med dubbelklick för alla andra.',
  download_btn_cli: 'Ladda ner för kommandoraden (Node.js)',
  download_btn_html: 'Ladda ner den lokala HTML-versionen',
  download_version: 'v0.3.0 · samma verifieringsmotor, två format',
