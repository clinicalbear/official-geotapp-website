...
const pt: VerifierCopy = {
  ...
  hero_cta_download: 'Baixar o verificador',
  cta_download: 'Baixar Verifier grátis',
  download_badge: 'Download gratuito',
  download_title: 'Baixar GeoTapp Verifier.',
  download_desc: 'Verifique offline a integridade dos relatórios GeoTapp. Sem conta necessária: pelo terminal ou biblioteca Node.js para quem desenvolve, ou um único arquivo HTML que abre com duplo clique para todos os outros.',
  download_btn_cli: 'Baixar para linha de comando (Node.js)',
  download_btn_html: 'Baixar a versão HTML local',
  download_version: 'v0.3.0 · mesmo motor de verificação, dois formatos',
  download_requirements: 'Requer Node.js ≥ 18',
  download_cli_title: 'Do terminal',
