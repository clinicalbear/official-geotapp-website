...
const da: VerifierCopy = {
  ...
  download_desc: 'Bekræft offline integriteten af GeoTapp-rapporter. Ingen konto nødvendig: via terminal eller Node.js-bibliotek for udviklere, eller en enkelt HTML-fil, der åbner med dobbeltklik for alle andre.',
  download_btn_cli: 'Download til kommandolinjen (Node.js)',
  download_btn_html: 'Download den lokale HTML-version',
  download_version: 'v0.3.0 · samme verifikationsmotor, to formater',
