...
const de: VerifierCopy = {
  ...
  download_desc: 'Offline-Prüfung der Integrität von GeoTapp-Berichten. Kein Konto nötig: über Terminal oder Node.js-Bibliothek für Entwickler, oder als einzelne HTML-Datei, die per Doppelklick öffnet, für alle anderen.',
