  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Una vez creadas, las sesiones de trabajo quedan protegidas: la hora de inicio, la posición registrada en el fichaje y la identidad de la persona usuaria no son modificables por la persona trabajadora, y la eliminación queda reservada a quienes administran. Las sesiones con posición nacen solo a través de una función del lado del servidor con privilegios administrativos, no por escritura directa desde la aplicación, de modo que quien ficha no puede retrodatar un fichaje, mover su posición ni hacerlo desaparecer.',
