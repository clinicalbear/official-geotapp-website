  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Zodra de werksessies zijn aangemaakt, zijn ze beschermd: het begintijdstip, de bij het klokmoment vastgelegde locatie en de identiteit van de gebruiker kunnen niet door de werknemer worden gewijzigd, en verwijderen is voorbehouden aan beheerders. Sessies met locatie ontstaan alleen via een functie aan de serverzijde met beheerdersrechten, niet door rechtstreeks schrijven vanuit de app, zodat de gebruiker een klokmoment niet kan terugdateren, de locatie niet kan verschuiven en het niet kan laten verdwijnen.',
